...
- 209 files · ~199,716 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 2343 nodes · 3743 edges · 180 communities (146 shown, 34 thin omitted)
...
Cohesion: 0.15
Nodes (15): root, DomainPanel(), DomainPanelProps, isValidUrl(), App(), loadAll(), reloadActiveTab(), DomainPanel() (+7 more)
...
- **1015 isolated node(s):** `$schema`, `sessionName`, `profile`, `headed`, `hideScrollbars` (+1010 more)
