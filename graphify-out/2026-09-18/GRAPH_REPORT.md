# Graph Report - Ext-Morbis-Manap (2026-09-18)

## Corpus Check

- 209 files · ~199,455 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 2342 nodes · 3742 edges · 181 communities (147 shown, 34 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 98 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `c1b496db`
...
Cohesion: 0.06
Nodes (76): BATCH_DELETE_CONFIG, closeBatchDeleteModal(), crawlDokumenPasienDelete(), crawlDokumenPasienDeleteToSidepanel(), deleteDokumen(), DeleteItem, deleteQueue, deleteSingleFromQueue() (+68 more)
...
Cohesion: 0.05
Nodes (89): confirmBatal(), getIdFromOnclick(), injectLab(), injectRadio(), injectRadioForm(), isEnabled(), makeBtn(), run() (+81 more)
...
Cohesion: 0.14
Nodes (17): App(), CARA_KELUAR, Hitt, IcdAutocomplete(), JENIS_KASUS, KEADAAN_KELUAR, PEMERIKSAAN_LANJUT, Props (+9 more)
...
Cohesion: 0.26
Nodes (7): Window, PopupState, getConfig(), getConfigWithFallback(), CustomUrl, ExtensionConfig, FeatureModule
...
Cohesion: 0.19
Nodes (10): DomainPanel(), DomainPanelProps, isValidUrl(), DomainPanel(), DomainPanelProps, ROLE_LABELS, ROLES, StatusCard() (+2 more)
...
Cohesion: 0.22
Nodes (9): lucide-react, devDependencies, lucide-react, @playwright/test, postcss, @vitejs/plugin-react, @playwright/test, postcss (+1 more)
...
Cohesion: 0.19
Nodes (17): debouncedScan(), extractIdVisitFromRow(), extractPatientInfo(), g, initPreOpMarker(), scanAndInjectPreOpButtons(), updateRowVisual(), isPreOp() (+9 more)
...
Cohesion: 0.33
Nodes (7): BACK_DETAIL_BTN, extractParam(), formatDate(), g, generateDetailUrl(), isExecutionPage(), renderBackToDetailButton()
...
Cohesion: 0.21
Nodes (15): FALLBACK_CANDIDATES, flushRetryQueue(), getRetryQueue(), probeFarmasiAppBase(), pushQueueEvent(), pushQueueEventDirect(), QAResult, QueueEventPayload (+7 more)
...
Cohesion: 0.09
Nodes (33): id, App(), AppProps, validate(), ClinicalNotesSection(), ClinicalNotesSectionProps, DiagnosaSection(), Hit (+25 more)
...
Cohesion: 0.12
Nodes (14): root, queueApiFetch(), App(), loadAll(), reloadActiveTab(), MessageHandler, MessageType, MessageTypes (+6 more)
...
Cohesion: 0.40
Nodes (4): DisplayTarget, setMode(), takeOver(), TARGETS
