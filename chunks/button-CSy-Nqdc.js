...
__name$17(isFunction$2, "isFunction");
...
__name$13(SwitchProvider, "SwitchProvider");
var TRIGGER_NAME$1 = "SwitchTrigger";
var SwitchTrigger = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$13(function SwitchTrigger2({ __scopeSwitch, onClick, ...switchProps }, forwardedRef) {
...
var Switch$1 = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$13(function Switch2(props, forwardedRef) {
...
var SwitchThumb = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$13(function SwitchThumb2(props, forwardedRef) {
...
var SwitchBubbleInput = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$13(function SwitchBubbleInput2({ __scopeSwitch, onClick, ...props }, forwardedRef) {
...
var SelectTrigger = (0, import_react.forwardRef)(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectTrigger$1, {
	ref,
	className: cn("flex h-11 w-full items-center justify-between gap-2 rounded-lg border-2 border-input bg-background px-3.5 py-2.5 text-base text-foreground", "focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 border-primary/50", "disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-muted", "[&>span]:line-clamp-1", className),
	...props,
	children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectIcon, {
		asChild: true,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "h-5 w-5 opacity-60 flex-shrink-0" })
	})]
}));
...
var SelectContent = (0, import_react.forwardRef)(({ className, children, position = "item-aligned", container, ...props }, ref) => {
	const resolved = container ?? getShadowApp();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectPortal, {
		container: resolved,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent$1, {
			ref,
			className: cn("relative z-[2147483647] max-h-[360px] min-w-[12rem] overflow-hidden rounded-lg border bg-popover text-popover-foreground shadow-lg", "data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95", "data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95", position === "popper" && "data-[side=bottom]:translate-y-1 data-[side=top]:-translate-y-1", className),
			position,
			...props,
...
var SelectItem = (0, import_react.forwardRef)(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem$1, {
	ref,
	className: cn("relative flex w-full cursor-default select-none items-center rounded-md px-3 py-2.5 text-base outline-none", "focus:bg-accent focus:text-accent-foreground", "data-[disabled]:pointer-events-none data-[disabled]:opacity-50", className),
	...props,
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-base font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0", {
	variants: {
		variant: {
			...
			outline: "border-2 border-border bg-background shadow-sm hover:bg-accent hover:text-accent-foreground active:bg-accent",
