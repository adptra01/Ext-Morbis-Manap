"use strict";var __morbis_feature=(()=>{var l={background:"#ffffff",foreground:"#0a0a0e",card:"#ffffff",cardForeground:"#0a0a0e",primary:"#2469f0",primaryForeground:"#f8fafc",primaryHover:"#1d58cc",secondary:"#f1f5f9",secondaryForeground:"#1e293b",muted:"#f1f5f9",mutedForeground:"#64748b",accent:"#f1f5f9",accentForeground:"#1e293b",destructive:"#ef4444",destructiveForeground:"#f8fafc",border:"#e2e8f0",input:"#e2e8f0",ring:"#2469f0",success:"#1b8a4b",successBg:"#eaf6ef",warning:"#c47a1a",warningBg:"#fef4e4",error:"#ef4444",errorBg:"#fef2f2",info:"#2469f0",infoBg:"#eef3ff"};var E=new Set;function y(n,t){if(E.has(n)){let c=document.getElementById(n);if(c)return c}let a=document.createElement("style");return a.id=n,a.textContent=t,document.head.appendChild(a),E.add(n),a}y("ext-shared-animations",`
  @keyframes fadeSlideIn {
    from { opacity: 0; transform: translateY(8px); }
    to { opacity: 1; transform: translateY(0); }
  }
`);var C='"Plus Jakarta Sans", -apple-system, "Segoe UI", Roboto, Arial, sans-serif',A=`
  :host {
    /* Brand */
    --ext-primary: #00875a;
...
`,p=null;function S(){return p||(p=new CSSStyleSheet,p.replaceSync(A)),p}var w=!1;function T(){if(w||document.getElementById("ext-pjs-font"))return;w=!0;let n=document.createElement("link");n.id="ext-pjs-font",n.rel="stylesheet",n.href="http://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap",document.head.appendChild(n)}function x(n,t="open"){let a=n.attachShadow({mode:t});return a.adoptedStyleSheets=[S()],T(),a}var M=`
...
`,g=class extends HTMLElement{constructor(){super();this.handleKey=a=>{a.key==="Escape"&&this.hasAttribute("open")&&this.cancel()};this.root=x(this),this.root.innerHTML=`
  ...
  `);let c=setInterval(function(){t++;let e=document.documentElement.getAttribute("data-ext-ttv-editor");e!==null?(clearInterval(c),e==="1"&&h()):t>=100&&clearInterval(c)},50);function h(){if(!window.location.pathname.includes("/surat-pengantar-ri"))return;let e=setInterval(function(){let r=document.getElementById("formDataRujukan"),s=document.querySelectorAll("input.hanya_baca");r&&s.length>0&&(clearInterval(e),L(s))},200)}function L(e){let r=[];e.forEach(function(s,i){let o=s,d=a.find(function(u){return u.index===i});d&&(o.removeAttribute("readonly"),o.classList.remove("hanya_baca"),o.classList.add("ext-ttv-editable"),o.setAttribute("name",d.name),o.setAttribute("data-ext-ttv",d.name),o.setAttribute("placeholder",d.min+"-"+d.max),o.type="number",o.min=String(d.min),o.max=String(d.max),o.step=String(d.step),o.addEventListener("input",function(){k(o,d)}),o.addEventListener("blur",function(){k(o,d)}),r.push(o))}),$(r)}function k(e,r){let s=parseFloat(e.value);if(e.classList.remove("ext-ttv-valid","ext-ttv-invalid"),e.value!==""){if(isNaN(s)||s<r.min||s>r.max?(e.classList.add("ext-ttv-invalid"),e.title=r.label+" harus antara "+r.min+"-"+r.max+" "+r.unit):(e.classList.add("ext-ttv-valid"),e.title=""),r.name==="sistol"){let i=document.querySelector('input[data-ext-ttv="diastol"]');i&&i.value&&e.value&&parseFloat(e.value)<=parseFloat(i.value)&&(e.classList.remove("ext-ttv-valid"),e.classList.add("ext-ttv-invalid"),e.title="Sistol harus lebih besar dari Diastol")}if(r.name==="diastol"){let i=document.querySelector('input[data-ext-ttv="sistol"]');i&&i.value&&e.value&&parseFloat(e.value)>=parseFloat(i.value)&&(e.classList.remove("ext-ttv-valid"),e.classList.add("ext-ttv-invalid"),e.title="Diastol harus lebih kecil dari Sistol")}}}function $(e){let r=document.getElementById("formDataRujukan");if(!r||r.querySelector(".ext-ttv-bar"))return;let s=document.createElement("span");s.className="ext-ttv-status",s.textContent="Editable";let i=document.createElement("ext-btn");i.setAttribute("variant","secondary"),i.setAttribute("size","sm"),i.textContent="Kunci TTV";let o=document.createElement("ext-badge");o.setAttribute("variant","info"),o.textContent="TTV Editor";let d=document.createElement("div");d.className="ext-ttv-bar",d.append(o,s,i),r.insertBefore(d,r.firstChild);let u=!1;i.addEventListener("click",function(){u=!u,e.forEach(function(f){u?(f.classList.add("ext-ttv-locked"),f.readOnly=!0):(f.classList.remove("ext-ttv-locked"),f.readOnly=!1)}),s.textContent=u?"Locked":"Editable",s.classList.toggle("ext-ttv-status-locked",u),i.textContent=u?"Buka TTV":"Kunci TTV"})}})();})();
