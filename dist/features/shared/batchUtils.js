"use strict";var __morbis_feature=(()=>{var p=Object.defineProperty;var E=Object.getOwnPropertyDescriptor;var j=Object.getOwnPropertyNames;var z=Object.prototype.hasOwnProperty;var B=(e,t)=>{for(var o in t)p(e,o,{get:t[o],enumerable:!0})},I=(e,t,o,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of j(t))!z.call(e,i)&&i!==o&&p(e,i,{get:()=>t[i],enumerable:!(r=E(t,i))||r.enumerable});return e};var L=e=>I(p({},"__esModule",{value:!0}),e);var M={};B(M,{Icons:()=>c,iconWrap:()=>T,injectSharedCSS:()=>u,registerGlobalBatchUtils:()=>C,safeFetch:()=>m,showErrorToast:()=>v,showInlinePreviewSafe:()=>k,toggleProcessingState:()=>w});var g="ext-batch-shared-style";function u(){if(document.getElementById(g))return;let e=document.createElement("style");e.id=g,e.textContent=`
    .ext-modal-content {
