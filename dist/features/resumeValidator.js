"use strict";var __morbis_feature=(()=>{var I={background:"#ffffff",foreground:"#0a0a0e",card:"#ffffff",cardForeground:"#0a0a0e",primary:"#2469f0",primaryForeground:"#f8fafc",primaryHover:"#1d58cc",secondary:"#f1f5f9",secondaryForeground:"#1e293b",muted:"#f1f5f9",mutedForeground:"#64748b",accent:"#f1f5f9",accentForeground:"#1e293b",destructive:"#ef4444",destructiveForeground:"#f8fafc",border:"#e2e8f0",input:"#e2e8f0",ring:"#2469f0",success:"#1b8a4b",successBg:"#eaf6ef",warning:"#c47a1a",warningBg:"#fef4e4",error:"#ef4444",errorBg:"#fef2f2",info:"#2469f0",infoBg:"#eef3ff"};var Be=new Set;function fe(e,a){if(Be.has(e)){let s=document.getElementById(e);if(s)return s}let n=document.createElement("style");return n.id=e,n.textContent=a,document.head.appendChild(n),Be.add(e),n}fe("ext-shared-animations",`
  @keyframes fadeSlideIn {
    from { opacity: 0; transform: translateY(8px); }
    to { opacity: 1; transform: translateY(0); }
  }
`);var Ht=/^[A-Z][0-9][0-9](\.[0-9]{1,2})?$/,jt=/^[0-9]{2}(\.[0-9]{1,2})?$/,Bt=/^(\d{1,3})\/(\d{1,3})$/,Ot=/^\d+(\.\d+)?$/;function v(e){let a=e.trim();return a===""||/^[-–—]+$/.test(a)}function z(e){return Ht.test(e.trim().toUpperCase())}function ee(e){return jt.test(e.trim())}function ge(e){let a=e.trim().replace(/\s+/g,""),n=Bt.exec(a);if(!n)return!1;let s=parseInt(n[1],10),l=parseInt(n[2],10);return s>=50&&s<=250&&l>=20&&l<=160}function L(e,a,n){let s=e.trim().replace(",",".");if(!Ot.test(s))return!1;let l=parseFloat(s);return!isNaN(l)&&l>=a&&l<=n}function he(e){return/[\p{L}\p{N}]/u.test(e)}var Pt='"Plus Jakarta Sans", -apple-system, "Segoe UI", Roboto, Arial, sans-serif',$t=`
  :host {
    /* Brand */
    --ext-primary: #00875a;
