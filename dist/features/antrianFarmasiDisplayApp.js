...
var __morbis_feature = (() => {
  ...
  (function() {
    ...
    function takeOver() {
      ...
      corner.style.cssText = "position:fixed;bottom:8px;right:12px;font:11px/1.4 system-ui,sans-serif;color:#adb5cd;z-index:1;background:rgba(255,255,255,.7);padding:2px 8px;border-radius:6px;";
