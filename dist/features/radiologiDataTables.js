...
<div class="ext-modal-body"><div class="ext-modal-grid">${t}</div></div>
  ...
  function M(n, e) {
    let t = n.getAttribute('data-original');
    if (!t) return !1;
    let a = document.createElement('div');
    ((a.style.display = 'none'), (a.innerHTML = atob(t)), document.body.appendChild(a));
    let l =
        {
    ...
    return (
      a.querySelectorAll('a').forEach((o) => {
        if (r) return;
        let d = o.getAttribute('onclick') || '',
          s = o.getAttribute('href') || '';
        l.some((c) => d.includes(c) || s.includes(c)) && (o.click(), (r = !0));
      }),
  ...
  function A(n) {
    let e = n.getAttribute('data-original');
    if (!e) return !1;
    let t = document.createElement('div');
    ((t.style.display = 'none'), (t.innerHTML = atob(e)), document.body.appendChild(t));
    let i =
      t
        .querySelector('[onclick*="editBacaan"],[onclick*="showAddFotoRadiologi"]')
        ?.getAttribute('onclick') || '';
    document.body.removeChild(t);
    let l = i.match(/[?&]id=(\d+)/),
      r = i.match(/[?&]id_visit=(\d+)/);
    if (!l) return !1;
    let o = l[1],
      d = r ? r[1] : '',
      s = window;
    return typeof s.batal_radiologi == 'function'
      ? (s.batal_radiologi(o), !0)
      : typeof s.batal_pengajuan == 'function'
        ? (s.batal_pengajuan(o, d), !0)
        : !1;
  }
  function S(n) {
    (n.addEventListener('click', (e) => {
      ...
      if (i) {
        e.preventDefault();
        let l = i.closest('.ext-action-menu'),
          r = i.closest('.ext-action-dropdown'),
          o = i.getAttribute('data-col');
  ...
  function x() {
    ...
    t.querySelectorAll('tbody tr').forEach((r) => {
      ...
      if (s) {
        ...
        c && !s.querySelector('.ext-badge') && (s.innerHTML = v(c));
      }
    ...
    for (let r of [5, 6, 7, 8, 10, 11, 12, 13])
      ...
      (console.log(`[${f}] start`),
        ...
        b(f).then(() => {
          ...
          (function i() {
            ...
            l && l.querySelectorAll('tr').length > 1 ? x() : a++ < 30 && setTimeout(i, 300);
          })();
        }));
    })();
  })();
