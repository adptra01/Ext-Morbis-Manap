...
var __morbis_feature = (() => {
  ...
  (function () {
    ...
    function addOverlayCSS() {
      ...
      s.textContent =
        '#isi,#body,#header,#content{display:none!important;}body{background:#D5E9DB!important;}#ext-mesin-loader{transition:opacity .2s ease-out;}html[data-ext-antrian-tools-health="ui"] #ext-mesin-loader{opacity:0!important;pointer-events:none!important;}@keyframes ext-m-load{0%{transform:translateX(-100%);}100%{transform:translateX(350%);}}';
