...
var __morbis_feature = (() => {
  ...
  (function() {
    ...
    function hideOld() {
      ...
      s.textContent = "html[data-ext-antrian-tools] body{background:#C2DCCB!important;}html[data-ext-antrian-tools] #isi{display:none!important;}@keyframes ext-m-load{0%{transform:translateX(-100%);}100%{transform:translateX(350%);}}";
    ...
    function addOverlay() {
      ...
      l.style.cssText = 'position:fixed;inset:0;z-index:999990;display:flex;align-items:center;justify-content:center;background:#C2DCCB;font-family:Inter,"Segoe UI",system-ui,sans-serif;';
