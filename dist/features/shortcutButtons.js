...
`
  ...
  function triageIgdUrl() {
    ...
    const id = extractIdVisit();
    return id ? buildUrl(SHORTCUT_URLS.triageIgd, `id_visit=${id}&status_periksa=belum&page=51`) : null;
  }
  ...
  function renderShortcutButtons() {
    if (!(g.currentConfig?.features?.shortcutButtons?.enabled && g.ExtensionCore.isFeatureAllowed("shortcutButtons")))
      return;
