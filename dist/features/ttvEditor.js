...
var __morbis_feature = (() => {
  ...
  (function() {
    ...
    function addTogglePanel(inputs) {
      ...
      toggleBar.innerHTML = '<span class="ext-ttv-badge">TTV Editor</span><span class="ext-ttv-status">Editable</span><button type="button" class="ext-ttv-lock-btn" id="ext-ttv-lock">Kunci TTV</button>';
