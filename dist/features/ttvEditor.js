  ...
  `
    ...
    function validateField(inp, field) {
      ...
      if (field.name === "sistol") {
        ...
        if (diastolInp && diastolInp.value && inp.value && parseFloat(inp.value) <= parseFloat(diastolInp.value)) {
      ...
      if (field.name === "diastol") {
        ...
        if (sistolInp && sistolInp.value && inp.value && parseFloat(inp.value) >= parseFloat(sistolInp.value)) {
          inp.classList.remove("ext-ttv-valid");
          inp.classList.add("ext-ttv-invalid");
