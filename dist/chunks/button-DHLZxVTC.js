var e = Object.create,
  ...
  d = o((e) => {
    ...
    function j(e, r, i, a, o) {
      ...
      var l = a === `` ? `.` : a + `:`;
      if (S(e))
        for (var u = 0; u < e.length; u++) ((a = e[u]), (s = l + k(a, u)), (c += j(a, r, i, s, o)));
  ...
  h = o((e) => {
    ...
    var se = P(null),
      ...
      le = P(null);
    function ue(e, t) {
      switch ((I(ce, t), I(L, e), I(se, null), t.nodeType)) {
        case 9:
        case 11:
    ...
    function fe(e) {
      (L.current === e && (F(se), F(L)), le.current === e && (F(le), (Qf._currentValue = ie)));
    }
    var pe, me;
    function he(e) {
      if (pe === void 0)
...
` +
    ...
    var be = Object.prototype.hasOwnProperty,
      ...
      Fe = null;
    function Ie(e) {
      if ((typeof Me == `function` && Ne(e), Fe && typeof Fe.setStrictMode == `function`))
        try {
          Fe.setStrictMode(Pe, e);
        } catch {}
    }
    var Le = Math.clz32 ? Math.clz32 : Be,
      Re = Math.log,
      ze = Math.LN2;
    function Be(e) {
    ...
    function Ge(e, t, n) {
      ...
      return (
        s === 0
          ...
          : ((r = s & ~a),
            r === 0
              ? ((o &= s), o === 0 ? n || ((n = s & ~e), n !== 0 && (i = We(n))) : (i = We(o)))
              : (i = We(r))),
        i === 0
          ? 0
          : t !== 0 &&
    ...
    var at = Math.random().toString(36).slice(2),
      ot = `__reactFiber$` + at,
      st = `__reactProps$` + at,
      ct = `__reactContainer$` + at,
      lt = `__reactEvents$` + at,
      ut = `__reactListeners$` + at,
      dt = `__reactHandles$` + at,
      ft = `__reactResources$` + at,
      pt = `__reactMarker$` + at;
    function mt(e) {
    ...
    function vt(e) {
      var t = e[ft];
      return ((t ||= e[ft] = { hoistableStyles: new Map(), hoistableScripts: new Map() }), t);
    }
    function z(e) {
      e[pt] = !0;
    }
    ...
    function V(e, t, n, r, i, a, o, s) {
      ((e.name = ``),
        ...
        t == null
          ...
          : o === `number`
            ? ((t === 0 && e.value === ``) || e.value != t) && (e.value = `` + B(t))
            : e.value !== `` + B(t) && (e.value = `` + B(t)),
        t == null
          ? n == null
    ...
    var _n = {
      ...
      wn = h({}, yn, {
        ...
        movementX: function (e) {
          return `movementX` in e
            ...
            : (e !== Cn &&
                (Cn && e.type === `mousemove`
                  ? ((xn = e.screenX - Cn.screenX), (Sn = e.screenY - Cn.screenY))
                  : (Sn = xn = 0),
                (Cn = e)),
              xn);
        },
      ...
      On = gn(h({}, _n, { animationName: 0, elapsedTime: 0, pseudoElement: 0 })),
      kn = gn(
        h({}, _n, {
    ...
    function nr(e, t, n, r) {
      ($t ? (en ? en.push(r) : (en = [r])) : ($t = r),
        (t = Ed(t, `onChange`)),
        0 < t.length &&
          ((n = new vn(`onChange`, `change`, null, n, r)), e.push({ event: n, listeners: t })));
    }
    var rr = null,
      ir = null;
    function ar(e) {
    ...
    function li(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) oi(e) && (s = 1);
        ...
        s = Uf(e, n, se.current) ? 26 : e === `html` || e === `head` || e === `body` ? 27 : 5;
      else
        a: switch (e) {
          case te:
            return ((e = ai(31, n, t, a)), (e.elementType = te), (e.lanes = o), e);
          case y:
            return ui(n.children, a, o, t);
          case b:
            ((s = 8), (a |= 24));
            break;
          case x:
            return ((e = ai(12, n, t, a | 2)), (e.elementType = x), (e.lanes = o), e);
          case T:
            return ((e = ai(13, n, t, a)), (e.elementType = T), (e.lanes = o), e);
          case ee:
            return ((e = ai(19, n, t, a)), (e.elementType = ee), (e.lanes = o), e);
          default:
    ...
    function hi(e, t) {
      if (typeof e == `object` && e) {
        var n = mi.get(e);
        return n === void 0 ? ((t = { value: e, source: t, stack: ye(t) }), mi.set(e, t), t) : n;
      }
    ...
    function Ii(e) {
      ...
      switch (((t[ot] = e), (t[st] = r), n)) {
        ...
        case `input`:
          (Q(`invalid`, t),
            Lt(t, r.value, r.defaultValue, r.checked, r.defaultChecked, r.type, r.name, !0));
          break;
        case `select`:
          Q(`invalid`, t);
          break;
    ...
    function Ri(e) {
      ...
      if (
        ...
        t === 27
          ? ((t = ji), Zd(e.type) ? ((e = lf), (lf = null), (ji = e)) : (ji = t))
          : (ji = Ai ? cf(e.stateNode.nextSibling) : null);
      return !0;
    }
    function zi() {
      ((ji = Ai = null), (H = !1));
    ...
    function Ki(e) {
      ((e._currentValue = Hi.current), F(Hi));
    }
    function qi(e, t, n) {
      for (; e !== null;) {
        var r = e.alternate;
    ...
    function ea(e, t) {
      ...
      if (((t = { context: t, memoizedValue: n, next: null }), Wi === null)) {
        ...
        ((Wi = t), (e.dependencies = { lanes: 0, firstContext: t }), (e.flags |= 524288));
      } else Wi = Wi.next = t;
      return n;
    }
    var ta =
    ...
    function wa(e, t, n) {
      switch (
        ((n = e[n]), n === void 0 ? e.push(t) : n !== t && (t.then(Xt, Xt), (t = n)), t.status)
      ) {
        case `fulfilled`:
          return t.value;
        case `rejected`:
    ...
    function Pa(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === y
          ...
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` && i && i.$$typeof === D && Ta(i) === t.type))
            ? ((t = a(t, n.props)), Ma(t, n), (t.return = e), t)
            : ((t = li(n.type, n.key, n.props, null, e.mode, r)), Ma(t, n), (t.return = e), t);
      }
      function u(e, t, n, r) {
        return t === null ||
          t.tag !== 4 ||
      ...
      function f(e, t, n) {
        ...
        if (typeof t == `object` && t) {
          ...
          if (re(t) || A(t)) return ((t = ui(t, e.mode, n, null)), (t.return = e), t);
          ...
          switch (o.$$typeof) {
            case _:
              a: {
                for (var l = o.key; r !== null;) {
                  if (r.key === l) {
                    if (((l = o.type), l === y)) {
                      ...
                      r.elementType === l ||
                      (typeof l == `object` && l && l.$$typeof === D && Ta(l) === r.type)
                    ) {
                ...
                o.type === y
                  ? ((c = ui(o.props.children, e.mode, c, o.key)), (c.return = e), (e = c))
                  : ((c = li(o.type, o.key, o.props, null, e.mode, c)),
                    Ma(c, o),
                    (c.return = e),
                    (e = c));
              }
        ...
        return (typeof o == `string` && o !== ``) || typeof o == `number` || typeof o == `bigint`
          ? ((o = `` + o),
            r !== null && r.tag === 6
              ...
              : (n(e, r), (c = di(o, e.mode, c)), (c.return = e), (e = c)),
            s(e))
          : n(e, r);
      }
    ...
    function no(e) {
      ...
      (I(so, so.current & 1),
        I(eo, e),
        to === null && (t === null || Ya.current !== null || t.memoizedState !== null) && (to = e));
    }
    function ro(e) {
    ...
    function Io(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !yr(o, e.memoizedState) && ((nc = !0), d && ((n = ua), n !== null)))
        )
          throw n;
    ...
    function ts(e, t, n) {
      ...
      return (
        n !== t.memoizedState &&
          ((U.flags |= 2048), is(9, { destroy: void 0 }, ns.bind(null, i, n), null)),
        [r, a, e]
      );
    }
    function ns(e, t) {
    ...
    function ec(e, t, n, r, a) {
      ...
      if (H)
        return (
          (t = eo.current),
          t === null
            ? (r !== Pi && ((t = Error(i(423), { cause: r })), Vi(hi(t, n))),
            ...
            : (!(t.flags & 65536) && (t.flags |= 256),
              (t.flags |= 65536),
              (t.lanes = a),
              r !== Pi && ((e = Error(i(422), { cause: r })), Vi(hi(e, n)))),
          !1
        );
      var o = Error(i(520), { cause: r });
      if (((o = hi(o, n)), Xl === null ? (Xl = [o]) : Xl.push(o), Wl !== 4 && (Wl = 2), t === null))
        return !0;
      ((r = hi(r, n)), (n = t));
      do {
        switch (n.tag) {
    ...
    function ic(e, t, n, r, i) {
      ...
      return (
        ...
        e !== null && !nc
          ? (Eo(e, t, i), Oc(e, t, i))
          : (H && s && Di(t), (t.flags |= 1), rc(e, t, r, i), t.child)
      );
    }
    function ac(e, t, n, r, i) {
      if (e === null) {
        var a = n.type;
        return typeof a == `function` && !oi(a) && a.defaultProps === void 0 && n.compare === null
      ...
      if (((a = e.child), !kc(e, i))) {
        ...
        if (((n = n.compare), (n = n === null ? br : n), n(o, r) && e.ref === t.ref))
          return Oc(e, t, i);
      }
    ...
    function fc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((ro(t), a))
          ...
          if (((r = q), r !== null && ((s = et(r, n)), s !== 0 && s !== o.retryLane)))
            throw ((o.retryLane = s), ei(e, s), hu(r, e, s), tc);
          (Du(), (t = dc(e, t, n)));
        } else
          ((e = o.treeContext),
            (ji = cf(s.nextSibling)),
    ...
    function mc(e, t, n, r, i) {
      return (
        ...
        e !== null && !nc
          ? (Eo(e, t, i), Oc(e, t, i))
          : (H && r && Di(t), (t.flags |= 1), rc(e, t, n, i), t.child)
      );
    }
    function hc(e, t, n, r, i, a) {
      return (
        ...
        e !== null && !nc
          ? (Eo(e, t, a), Oc(e, t, a))
          : (H && r && Di(t), (t.flags |= 1), rc(e, t, n, a), t.child)
      );
    }
    function gc(e, t, n, r, i) {
      if ((Zi(t), t.stateNode === null)) {
        ...
        (typeof o == `object` && o && (a = Qi(o)),
          ...
          Ra(t),
          (o = n.contextType),
          (a.context = typeof o == `object` && o ? Qi(o) : ri),
          (a.state = t.memoizedState),
        ...
        o !== d || f !== p || La || (e !== null && e.dependencies !== null && Xi(e.dependencies))
      ...
      return (
        ...
        a || r
          ? ((a = t.stateNode),
            ...
            (t.flags |= 1),
            e !== null && r
              ? ((t.child = Fa(t, e.child, null, i)), (t.child = Fa(t, null, n, i)))
              : rc(e, t, n, i),
    ...
    function xc(e, t, n) {
      var r = t.pendingProps,
        ...
        s;
      if (
        ((s = o) || (s = e !== null && e.memoizedState === null ? !1 : (so.current & 2) != 0),
        s && ((a = !0), (t.flags &= -129)),
        (s = (t.flags & 32) != 0),
        (t.flags &= -33),
        e === null)
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (((s = q), s !== null && ((r = et(s, n)), r !== 0 && r !== l.retryLane)))
            throw ((l.retryLane = r), ei(e, r), hu(s, e, r), tc);
          (af(c) || Du(), (t = wc(e, t, n)));
        } else
          af(c)
      ...
      return a
        ? (ao(t),
          ...
          u === null ? ((c = ui(c, a, n, null)), (c.flags |= 2)) : (c = si(u, c)),
          (c.return = t),
          (r.return = t),
          (r.sibling = c),
          (t.child = r),
          ...
          c === null
            ...
            : ((a = c.cachePool),
              a === null
                ? (a = va())
                : ((l = ia._currentValue), (a = a.parent === l ? a : { parent: l, pool: l })),
    ...
    function Sc(e, t) {
      return ((t = Cc({ mode: `visible`, children: t }, e.mode)), (t.return = e), (e.child = t));
    }
    function Cc(e, t) {
    ...
    function Ac(e, t, n) {
      switch (t.tag) {
        case 3:
          (ue(t, t.stateNode.containerInfo), Gi(t, ia, e.memoizedState.cache), zi());
          break;
        case 27:
        case 5:
          R(t);
        ...
        case 19:
          var i = (e.flags & 128) != 0;
          if (
            ((r = (n & t.childLanes) !== 0), (r ||= (Yi(e, t, n, !1), (n & t.childLanes) !== 0)), i)
          ) {
        ...
        case 27:
          return (
            ...
            e === null &&
              ...
              (Ni = !0),
              (a = ji),
              Zd(t.type) ? ((lf = a), (ji = cf(r.firstChild))) : (ji = a)),
          ...
          return (
            e === null &&
              ...
              ((a = r = ji) &&
                ...
                r === null
                  ? (a = !1)
                  : ((t.stateNode = r), (Ai = t), (ji = cf(r.firstChild)), (Ni = !1), (a = !0))),
              a || Fi(t)),
            R(t),
            (a = t.type),
            (o = t.pendingProps),
            ...
            t.memoizedState !== null && ((a = xo(e, t, wo, null, null, n)), (Qf._currentValue = a)),
            pc(e, t),
            rc(e, t, r, n),
            t.child
          );
          ...
          return (
            e === null &&
              ...
              ((e = n = ji) &&
                ...
                n === null ? (e = !1) : ((t.stateNode = n), (Ai = t), (ji = null), (e = !0))),
              e || Fi(t)),
            null
          );
        case 13:
          ...
          return (
            ...
            e === null
              ...
              : ((e.lanes & n) !== 0 && (za(e, t), Ka(t, null, null, n), Ga()),
                ...
                (o = t.memoizedState),
                a.parent === r
                  ? ((r = o.cache), Gi(t, ia, r), r !== a.cache && Ji(t, [ia], n, !0))
                  : ((a = { parent: r, cache: r }),
                    (t.memoizedState = a),
    ...
    function Fc(e, t) {
      (t !== null && (e.flags |= 4),
        e.flags & 16384 && ((t = e.tag === 22 ? 536870912 : Je()), (e.lanes |= t), (Yl |= t)));
    }
    function Ic(e, t) {
      if (!H)
        switch (e.tailMode) {
    ...
    function Lc(e, t, n) {
      ...
      switch ((Oi(t), t.tag)) {
        ...
        case 26:
          ...
          return (
            e === null
              ? (Mc(t), o === null ? (G(t), Nc(t, a, null, r, n)) : (G(t), Pc(t, o)))
              : o
                ? o === e.memoizedState
                  ? (G(t), (t.flags &= -16777217))
                  : (Mc(t), G(t), Pc(t, o))
                : ((e = e.memoizedProps), e !== r && Mc(t), G(t), Nc(t, a, e, r, n)),
            null
          );
        case 27:
          if ((fe(t), (n = ce.current), (a = t.type), e !== null && t.stateNode != null))
        ...
        case 6:
          if (e && t.stateNode != null) e.memoizedProps !== r && Mc(t);
            ...
            if (((e = ce.current), Ri(t))) {
              if (((e = t.stateNode), (n = t.memoizedProps), (r = null), (a = Ai), a !== null))
                switch (a.tag) {
                  case 27:
                  case 5:
                    r = a.memoizedProps;
        ...
        case 4:
          return (de(), e === null && Sd(t.stateNode.containerInfo), G(t), null);
        case 10:
          return (Ki(t.type), G(t), null);
        case 19:
          if ((F(so), (r = t.memoizedState), r === null)) return (G(t), null);
        ...
        case 23:
          return (
            ...
            r
              ? n & 536870912 && !(t.flags & 128) && (G(t), t.subtreeFlags & 6 && (t.flags |= 8192))
              : G(t),
            (n = t.updateQueue),
      ...
      switch (e.tag) {
        ...
        case 22:
          ...
          var l = n !== null && n.memoizedState !== null,
            u = $c,
            d = el;
          if ((($c = u || a), (el = d || l), hl(t, e), (el = d), ($c = u), vl(e), r & 8192))
            a: for (
              t = e.stateNode,
    ...
    function gu(e, t, n) {
      ...
      var r = (!n && (t & 127) == 0 && (t & e.expiredLanes) === 0) || Ke(e, t),
        a = r ? Au(e, t) : Ou(e, t, !0),
        o = r;
      do {
        if (a === 0) {
    ...
    function Cu(e, t) {
      ((U = null),
        ...
        t === ya || t === xa
          ...
          : t === ba
            ? ((t = Da()), (X = 4))
            : (X = t === tc ? 8 : typeof t == `object` && t && typeof t.then == `function` ? 6 : 1),
        (zl = t),
        J === null && ((Wl = 1), Ys(e, hi(t, e.current))));
    }
    function wu() {
      var e = eo.current;
      return e === null
    ...
    function Nu(e) {
      ...
      switch (t.tag) {
        ...
        case 5:
          Do(t);
        default:
          (zc(n, t), (t = J = ci(t, Ul)), (t = jc(n, t, Ul)));
      }
      ((e.memoizedProps = e.pendingProps), t === null ? Fu(e) : (J = t));
    }
    function Pu(e, t, n, r) {
      ...
      t.flags & 32768
        ? (H || r === 1
            ...
            : Vl || Y & 536870912
              ...
              : ((Bl = e = !0),
                (r === 2 || r === 9 || r === 3 || r === 6) &&
                  ((r = eo.current), r !== null && r.tag === 13 && (r.flags |= 16384))),
          Iu(t, e))
        : Fu(t);
    }
    function Fu(e) {
    ...
    function sd(e, t) {
      ...
      if (
        ((t = q),
        (n = Y),
        (n = Ge(e, e === t ? n : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1)),
        (r = e.callbackNode),
    ...
    function cd(e, t) {
      ...
      var r = Y;
      return (
        (r = Ge(e, e === q ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1)),
        r === 0
          ? null
          : (gu(e, r, t),
            sd(e, Te()),
    ...
    function md(e, t, n, r, i) {
      if (t === `submit` && n && n.stateNode === i) {
        var a = fd((i[st] || null).action),
          o = r.submitter;
        o &&
          ((t = (t = o[st] || null) ? fd(t.formAction) : o.getAttribute(`formAction`)),
          t !== null && ((a = t), (o = null)));
        ...
        if (!(t & 7)) {
          a: {
            if (
              ...
              c && n !== Zt && (u = n.relatedTarget || n.fromElement) && (ht(u) || u[ct]))
            )
              break a;
            if (
              (l || c) &&
              ...
              if (
                ...
                (e === `pointerout` || e === `pointerover`) &&
                  ((d = Ln), (g = `onPointerLeave`), (p = `onPointerEnter`), (m = `pointer`)),
                (f = l == null ? c : _t(l)),
                (h = u == null ? c : _t(u)),
          ...
          (x &&
            (Kn &&
              ...
              (Zn || x !== `onCompositionStart`
                ...
                : ((ln = i), (un = `value` in ln ? ln.value : ln.textContent), (Zn = !0))),
            (y = Ed(r, x)),
            0 < y.length &&
...
`,
      ...
      switch (n) {
        case `children`:
          typeof r == `string`
            ...
            : (typeof r == `number` || typeof r == `bigint`) && t !== `body` && Ht(e, `` + r);
          break;
        case `className`:
          Ot(e, `class`, r);
          break;
        ...
        ((i = `link[rel="` + e + `"][href="` + i + `"]`),
          ...
          hf.has(i) ||
            ...
            r.querySelector(i) === null &&
              ((t = r.createElement(`link`)), Pd(t, `link`, e), z(t), r.head.appendChild(t))));
      }
    }
    function Sf(e) {
    ...
    function Vf(e, t, n) {
      ...
      for (r.set(e, null), n = n.getElementsByTagName(e), i = 0; i < n.length; i++) {
        var a = n[i];
        if (
          !(a[pt] || a[ot] || (e === `link` && a.getAttribute(`rel`) === `stylesheet`)) &&
...
var y = o((e) => {
  ...
  C = class extends x.Component {
    ...
    componentDidCatch(e, t) {
      console.error(`[ErrorBoundary]`, e, t.componentStack);
    }
    render() {
...
var O = globalThis?.document ? x.useLayoutEffect : () => {},
  k = x.useInsertionEffect || O;
function A({ prop: e, defaultProp: t, onChange: n = () => {}, caller: r }) {
  let [i, a, o] = j({ defaultProp: t, onChange: n }),
    s = e !== void 0,
    c = s ? e : i;
  {
...
function re(e) {
  let t = x.useRef({ value: e, previous: e });
  return x.useMemo(
    () => (
...
function ie(e) {
  let t = x.forwardRef((t, n) => {
    let { children: r, ...i } = t,
      ...
      o = !1,
      s = [];
    (L(r) && typeof de == `function` && (r = de(r._payload)),
      x.Children.forEach(r, (e) => {
        if (I(e)) {
          o = !0;
          let t = e,
            n = `child` in t.props ? t.props.child : t.props.children;
          (L(n) && typeof de == `function` && (n = de(n._payload)),
            (a = oe(t, n)),
...
function ve(e) {
  let {
    ...
    [f, p] = A({ prop: n, defaultProp: i ?? !1, onChange: c, caller: pe }),
    [m, h] = x.useState(null),
    [g, _] = x.useState(null),
    v = {
      checked: f,
      ...
      form: o,
      value: u,
      hasConsumerStoppedPropagationRef: x.useRef(!1),
      required: l,
      defaultChecked: i,
  ...
  return (0, S.jsx)(ge, { scope: t, ...v, children: Ee(d) ? d(v) : r });
}
var ye = `SwitchTrigger`,
  be = x.forwardRef(({ __scopeSwitch: e, onClick: t, ...n }, r) => {
    let {
        control: i,
        form: a,
        value: o,
...
var xe = x.forwardRef((e, t) => {
  ...
  return (0, S.jsx)(ve, {
    ...
    internal_do_not_use_render: ({ isFormControl: e }) =>
      (0, S.jsxs)(S.Fragment, {
        children: [
          (0, S.jsx)(be, { ...d, ref: t, __scopeSwitch: n }),
          e && (0, S.jsx)(Te, { __scopeSwitch: n }),
        ],
      }),
  });
});
...
var Se = `SwitchThumb`,
  Ce = x.forwardRef((e, t) => {
    let { __scopeSwitch: n, ...r } = e,
      i = _e(Se, n);
    return (0, S.jsx)(R.span, {
      'data-state': De(i.checked),
...
Ce.displayName = Se;
var we = `SwitchBubbleInput`,
  Te = x.forwardRef(({ __scopeSwitch: e, ...t }, n) => {
    let {
        control: r,
...
var Ae = (e, t) => {
  ...
  je = (e, t) => ({ classGroupId: e, validator: t }),
  Me = (e = new Map(), t = null, n) => ({ nextPart: e, validators: t, classGroupId: n }),
  Ne = `-`,
  Pe = [],
  Fe = `arbitrary..`,
  Ie = (e) => {
  ...
  Le = (e, t, n) => {
    ...
    let a = n.validators;
    if (a === null) return;
    let o = t === 0 ? e.join(Ne) : e.slice(t).join(Ne),
      s = a.length;
    for (let e = 0; e < s; e++) {
      let t = a[e];
  ...
  $e = (e) => {
    let { prefix: t, experimentalParseClassName: n } = e,
      r = (e) => {
        ...
        s.endsWith(Ye)
          ? ((c = s.slice(0, -1)), (l = !0))
          : s.startsWith(Ye) && ((c = s.slice(1)), (l = !0));
  ...
  yt = (e) => !!e && Number.isInteger(Number(e)),
  bt = (e) => e.endsWith(`%`) && z(e.slice(0, -1)),
  xt = (e) => pt.test(e),
  St = () => !0,
  Ct = (e) => mt.test(e) && !ht.test(e),
  wt = () => !1,
  Tt = (e) => gt.test(e),
  Et = (e) => _t.test(e),
  Dt = (e) => !B(e) && !V(e),
  ...
  qt = (e) => e === `image` || e === `url`,
  Jt = (e) => e === `length` || e === `size` || e === `bg-size`,
  Yt = (e) => e === `length`,
  Xt = (e) => e === `number`,
  Zt = (e) => e === `family-name`,
  Qt = (e) => e === `number` || e === `weight`,
  $t = (e) => e === `shadow`,
  en = st(() => {
    let e = lt(`color`),
      t = lt(`font`),
      ...
      w = () => [V, B, c],
      T = () => [vt, `full`, `auto`, ...w()],
      ee = () => [yt, `none`, `subgrid`, V, B],
      E = () => [`auto`, { span: [`full`, yt, V, B] }, yt, V, B],
      D = () => [yt, `auto`, V, B],
      te = () => [`auto`, `min`, `max`, `fr`, V, B],
      O = () => [
        `start`,
        `end`,
        `center`,
      ...
      ne = () => [vt, `screen`, `full`, `dvw`, `lvw`, `svw`, `min`, `max`, `fit`, ...w()],
      re = () => [vt, `screen`, `full`, `lh`, `dvh`, `lvh`, `svh`, `min`, `max`, `fit`, ...w()],
      M = () => [e, V, B],
      N = () => [...b(), zt, Pt, { position: [V, B] }],
      ie = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
      ae = () => [`auto`, `cover`, `contain`, Bt, kt, { size: [V, B] }],
      oe = () => [bt, Lt, At],
      P = () => [``, `none`, `full`, l, V, B],
      F = () => [``, z, Lt, At],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: [`auto`, `square`, vt, B, V, g] }],
        container: [`container`],
        'container-type': [{ '@container': [``, `normal`, `size`, V, B] }],
        'container-named': [Ot],
        columns: [{ columns: [z, B, V, s] }],
        ...
        z: [{ z: [yt, `auto`, V, B] }],
        basis: [{ basis: [vt, `full`, `auto`, s, ...w()] }],
        'flex-direction': [{ flex: [`row`, `row-reverse`, `col`, `col-reverse`] }],
        'flex-wrap': [{ flex: [`nowrap`, `wrap`, `wrap-reverse`] }],
        flex: [{ flex: [z, vt, `auto`, `initial`, `none`, B] }],
        grow: [{ grow: [``, z, V, B] }],
        shrink: [{ shrink: [``, z, V, B] }],
        order: [{ order: [yt, `first`, `last`, `none`, V, B] }],
        ...
        'font-size': [{ text: [`base`, n, Lt, At] }],
        'font-smoothing': [`antialiased`, `subpixel-antialiased`],
        'font-style': [`italic`, `not-italic`],
        'font-weight': [{ font: [r, Ut, Mt] }],
        'font-stretch': [
          {
            'font-stretch': [
              `ultra-condensed`,
        ...
        tracking: [{ tracking: [i, V, B] }],
        'line-clamp': [{ 'line-clamp': [z, `none`, V, jt] }],
        leading: [{ leading: [a, ...w()] }],
        'list-image': [{ 'list-image': [`none`, V, B] }],
        'list-style-position': [{ list: [`inside`, `outside`] }],
        'list-style-type': [{ list: [`disc`, `decimal`, `none`, V, B] }],
        'text-alignment': [{ text: [`left`, `center`, `right`, `justify`, `start`, `end`] }],
        'placeholder-color': [{ placeholder: M() }],
        'text-color': [{ text: M() }],
        'text-decoration': [`underline`, `overline`, `line-through`, `no-underline`],
        'text-decoration-style': [{ decoration: [...I(), `wavy`] }],
        'text-decoration-thickness': [{ decoration: [z, `from-font`, `auto`, V, At] }],
        'text-decoration-color': [{ decoration: M() }],
        'underline-offset': [{ 'underline-offset': [z, `auto`, V, B] }],
        ...
        'bg-image': [
          {
            bg: [
              `none`,
              {
                linear: [{ to: [`t`, `tr`, `r`, `br`, `b`, `bl`, `l`, `tl`] }, yt, V, B],
                radial: [``, V, B],
                conic: [yt, V, B],
              },
              Vt,
        ...
        'outline-offset': [{ 'outline-offset': [z, V, B] }],
        'outline-w': [{ outline: [``, z, Lt, At] }],
        'outline-color': [{ outline: M() }],
        shadow: [{ shadow: [``, `none`, u, Ht, It] }],
        'shadow-color': [{ shadow: M() }],
        'inset-shadow': [{ 'inset-shadow': [`none`, d, Ht, It] }],
        'inset-shadow-color': [{ 'inset-shadow': M() }],
        'ring-w': [{ ring: F() }],
        'ring-w-inset': [`ring-inset`],
        'ring-color': [{ ring: M() }],
        'ring-offset-w': [{ 'ring-offset': [z, At] }],
        'ring-offset-color': [{ 'ring-offset': M() }],
        'inset-ring-w': [{ 'inset-ring': F() }],
        'inset-ring-color': [{ 'inset-ring': M() }],
        'text-shadow': [{ 'text-shadow': [`none`, f, Ht, It] }],
        'text-shadow-color': [{ 'text-shadow': M() }],
        opacity: [{ opacity: [z, V, B] }],
        ...
        'mask-image': [{ mask: [`none`, V, B] }],
        filter: [{ filter: [``, `none`, V, B] }],
        blur: [{ blur: ce() }],
        brightness: [{ brightness: [z, V, B] }],
        contrast: [{ contrast: [z, V, B] }],
        'drop-shadow': [{ 'drop-shadow': [``, `none`, p, Ht, It] }],
        'drop-shadow-color': [{ 'drop-shadow': M() }],
        grayscale: [{ grayscale: [``, z, V, B] }],
        'hue-rotate': [{ 'hue-rotate': [z, V, B] }],
        invert: [{ invert: [``, z, V, B] }],
        saturate: [{ saturate: [z, V, B] }],
        sepia: [{ sepia: [``, z, V, B] }],
        'backdrop-filter': [{ 'backdrop-filter': [``, `none`, V, B] }],
        'backdrop-blur': [{ 'backdrop-blur': ce() }],
        'backdrop-brightness': [{ 'backdrop-brightness': [z, V, B] }],
        'backdrop-contrast': [{ 'backdrop-contrast': [z, V, B] }],
        'backdrop-grayscale': [{ 'backdrop-grayscale': [``, z, V, B] }],
        'backdrop-hue-rotate': [{ 'backdrop-hue-rotate': [z, V, B] }],
        'backdrop-invert': [{ 'backdrop-invert': [``, z, V, B] }],
        'backdrop-opacity': [{ 'backdrop-opacity': [z, V, B] }],
        'backdrop-saturate': [{ 'backdrop-saturate': [z, V, B] }],
        'backdrop-sepia': [{ 'backdrop-sepia': [``, z, V, B] }],
        ...
        duration: [{ duration: [z, `initial`, V, B] }],
        ease: [{ ease: [`linear`, `initial`, _, V, B] }],
        delay: [{ delay: [z, V, B] }],
        animate: [{ animate: [`none`, v, V, B] }],
        backface: [{ backface: [`hidden`, `visible`] }],
        perspective: [{ perspective: [h, V, B] }],
        ...
        'skew-x': [{ 'skew-x': de() }],
        'skew-y': [{ 'skew-y': de() }],
        transform: [{ transform: [V, B, ``, `none`, `gpu`, `cpu`] }],
        ...
        'will-change': [{ 'will-change': [`auto`, `scroll`, `contents`, `transform`, V, B] }],
        fill: [{ fill: [`none`, ...M()] }],
        'stroke-w': [{ stroke: [z, Lt, At, jt] }],
...
var nn = (0, x.forwardRef)(({ className: e, ...t }, n) =>
  (0, S.jsx)(xe, {
    className: tn(
  ...
  let t = e + `CollectionProvider`,
    ...
    o = (e) => {
      let { scope: t, children: n } = e,
        r = x.useRef(null),
        a = x.useRef(new Map()).current;
      return (0, S.jsx)(i, { scope: t, itemMap: a, collectionRef: r, children: n });
    };
  o.displayName = t;
  let s = e + `CollectionSlot`,
    ...
    l = x.forwardRef((e, t) => {
      let { scope: n, children: r } = e,
        i = E(t, a(s, n).collectionRef);
      return (0, S.jsx)(c, { ref: i, children: r });
    });
  l.displayName = s;
  let u = e + `CollectionItemSlot`,
    ...
    p = x.forwardRef((e, t) => {
      let { scope: n, children: r, ...i } = e,
        ...
        c = a(u, n);
      return (
        x.useEffect(() => (c.itemMap.set(o, { ref: o, ...i }), () => void c.itemMap.delete(o))),
        (0, S.jsx)(f, { [d]: ``, ref: s, children: r })
      );
    });
  p.displayName = u;
  function m(t) {
...
var on = x.createContext(void 0);
function sn(e) {
  let t = x.useContext(on);
  return e || t || `ltr`;
}
function cn(e) {
  let t = x.useRef(e);
...
var ln = `DismissableLayer`,
  un = `dismissableLayer.update`,
  dn = `dismissableLayer.pointerDownOutside`,
  ...
  hn = x.forwardRef((e, t) => {
    ...
    return (
      ...
      x.useEffect(
        () => () => {
          d && (u.layers.delete(d), u.layersWithOutsidePointerEventsDisabled.delete(d), xn());
        },
        [d, u],
      ),
      x.useEffect(() => {
      ...
      (0, S.jsx)(R.div, {
        ...
        onPointerDownCapture: w(e.onPointerDownCapture, ee.onPointerDownCapture),
      })
    );
  });
hn.displayName = ln;
var gn = `DismissableLayerBranch`,
  _n = x.forwardRef((e, t) => {
...
function yn(e, t) {
  let {
      ...
      shouldHandlePointerDownOutside: o = vn,
    } = t,
    s = cn(e),
    c = x.useRef(!1),
    l = x.useRef(!1),
...
function bn(e, t = globalThis?.document) {
  ...
  return (
    x.useEffect(() => {
      let e = (e) => {
        e.target && !r.current && Sn(fn, n, { originalEvent: e }, { discrete: !1 });
      };
...
function Tn() {
  x.useEffect(() => {
    ...
    return (
      ...
      Cn++,
      () => {
        (Cn === 1 && (wn?.start.remove(), wn?.end.remove(), (wn = null)),
          (Cn = Math.max(0, Cn - 1)));
      }
    );
  }, []);
        ...
        let e = function (e) {
          ...
          n = function (e) {
            if (document.activeElement === document.body)
              for (let t of e) t.removedNodes.length > 0 && Rn(s);
          };
      ...
      x.useEffect(() => {
        if (s) {
          ...
          if (!s.contains(e)) {
            ...
            (s.addEventListener(Dn, l),
              s.dispatchEvent(t),
              t.defaultPrevented ||
                (Mn(Hn(Pn(s)), { select: !0 }), document.activeElement === e && Rn(s)));
          }
          return () => {
            (s.removeEventListener(Dn, l),
              setTimeout(() => {
                let t = new CustomEvent(On, kn);
                (s.addEventListener(On, u),
                  s.dispatchEvent(t),
                  t.defaultPrevented || Rn(e ?? document.body, { select: !0 }),
                  s.removeEventListener(On, u),
                  zn.remove(p));
              }, 0));
          };
        }
    ...
    let m = x.useCallback(
      (e) => {
        ...
        if (t && i) {
          ...
          r && a
            ? !e.shiftKey && i === a
              ? (e.preventDefault(), n && Rn(r, { select: !0 }))
              : e.shiftKey && i === r && (e.preventDefault(), n && Rn(a, { select: !0 }))
            : i === t && e.preventDefault();
        }
      },
      [n, r, p.paused],
    );
    return (0, S.jsx)(R.div, { tabIndex: -1, ...o, ref: f, onKeyDown: m });
  });
jn.displayName = An;
...
function Fn(e, t) {
  ...
  for (let r of e)
    if (!(n ? !r.checkVisibility({ checkVisibilityCSS: !0 }) : In(r, { upTo: t }))) return r;
}
...
var Un = x.useId || (() => void 0),
  Wn = 0;
function Gn(e) {
  let [t, n] = x.useState(Un());
  return (
    O(() => {
      e || n((e) => e ?? String(Wn++));
    }, [e]),
...
function vr(e) {
  return typeof e == `number` ? { top: e, right: e, bottom: e, left: e } : _r(e);
}
function yr(e) {
...
var Sr = 50,
  Cr = async (e, t, n) => {
    let { placement: r = `bottom`, strategy: i = `absolute`, middleware: a = [], platform: o } = n,
      s = o.detectOverflow ? o : { ...o, detectOverflow: xr },
    ...
    async fn(t) {
      ...
      let w = b / 2 - x / 2,
        ...
        A =
          ...
          nr(i) != null &&
          O !== k &&
          a.reference[m] / 2 - (O < D ? ee : E) - h[m] / 2 < 0,
        j = A ? (O < D ? O - D : O - te) : 0;
      return {
        [p]: f[p] + j,
        ...
        async fn(t) {
          ...
          if (((T = [...T, { placement: r, overflows: w }]), !w.every((e) => e <= 0))) {
            ...
            if (
              t &&
              (!(u === `alignment` && _ !== ar(t)) ||
                T.every((e) => ar(e.placement) !== _ || e.overflows[0] > 0))
            )
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          let { rects: n, platform: r } = t,
            { strategy: i = `referenceHidden`, ...a } = er(e, t);
          switch (i) {
            ...
            case `escaped`: {
              let e = Er(await r.detectOverflow(t, { ...a, altBoundary: !0 }), n.floating);
      ...
      e === void 0 && (e = {}),
      {
        ...
        fn(t) {
          let { x: n, y: r, placement: i, rects: a, middlewareData: o } = t,
            { offset: s = 0, mainAxis: c = !0, crossAxis: l = !0 } = er(e, t),
            u = { x: n, y: r },
            d = ar(i),
            f = rr(d),
            p = u[f],
        ...
        async fn(t) {
          ...
          if (
            ...
            let e = Jn(u.left, 0),
              ...
              r = Jn(u.bottom, 0);
            p
              ? (w = m - 2 * (e !== 0 || t !== 0 ? e + t : Jn(u.left, u.right)))
              : (C = h - 2 * (n !== 0 || r !== 0 ? n + r : Jn(u.top, u.bottom)));
          }
...
function zr(e) {
  return Fr() ? e instanceof Node || e instanceof Lr(e).Node : !1;
}
function Br(e) {
  return Fr() ? e instanceof Element || e instanceof Lr(e).Element : !1;
}
function Vr(e) {
  return Fr() ? e instanceof HTMLElement || e instanceof Lr(e).HTMLElement : !1;
}
function Hr(e) {
  return !Fr() || typeof ShadowRoot > `u`
    ? !1
    : e instanceof ShadowRoot || e instanceof Lr(e).ShadowRoot;
}
function Ur(e) {
  let { overflow: t, overflowX: n, overflowY: r, display: i } = ei(e);
...
var Kr = /transform|translate|scale|rotate|perspective|filter/,
...
function Xr(e) {
  ...
  return (
    ...
    Jr(t.rotate) ||
    Jr(t.perspective) ||
    (!Qr() && (Jr(t.backdropFilter) || Jr(t.filter))) ||
    Kr.test(t.willChange || ``) ||
    qr.test(t.contain || ``)
  );
}
function Zr(e) {
...
function Qr() {
  return (
    (Yr ??= typeof CSS < `u` && CSS.supports && CSS.supports(`-webkit-backdrop-filter`, `none`)),
    Yr
  );
}
function $r(e) {
...
function ni(e) {
  ...
  let t = e.assignedSlot || e.parentNode || (Hr(e) && e.host) || Rr(e);
  return Hr(t) ? t.host : t;
}
function ri(e) {
  let t = ni(e);
  return $r(t) ? (e.ownerDocument ? e.ownerDocument.body : e.body) : Vr(t) && Ur(t) ? t : ri(t);
}
function ii(e, t, n) {
  ...
  if (i) {
    let e = ai(a);
    return t.concat(a, a.visualViewport || [], Ur(r) ? r : [], e && n ? ii(e) : []);
  } else return t.concat(r, ii(r, [], n));
}
function ai(e) {
...
function ci(e) {
  ...
  let n = t.getBoundingClientRect(),
    { width: r, height: i, $: a } = oi(t),
    o = (a ? Yn(n.width) : n.width) / r,
    s = (a ? Yn(n.height) : n.height) / i;
  return (
...
function di(e, t, n) {
  return (t === void 0 && (t = !1), !n || (t && n !== Lr(e)) ? !1 : t);
}
function fi(e, t, n, r) {
  ...
  let i = e.getBoundingClientRect(),
    a = si(e),
    o = Zn(1);
  t && (r ? Br(r) && (o = ci(r)) : (o = ci(e)));
  let s = di(a, n, r) ? ui(a) : Zn(0),
    c = (i.left + s.x) / o.x,
    l = (i.top + s.y) / o.y,
    u = i.width / o.x,
    d = i.height / o.y;
  ...
  return yr({ width: u, height: d, x: c, y: l });
}
function pi(e, t) {
  let n = ti(e).scrollLeft;
  return t ? t.left + n : fi(Rr(e)).left + n;
}
function mi(e, t) {
  let n = e.getBoundingClientRect();
  return { x: n.left + t.scrollLeft - pi(e, n), y: n.top + t.scrollTop };
}
function hi(e) {
  ...
  let c = { scrollLeft: 0, scrollTop: 0 },
    ...
    u = Zn(0),
    d = Vr(r);
  if ((d || (!d && !a)) && ((Ir(r) !== `body` || Ur(o)) && (c = ti(r)), d)) {
    let e = fi(r);
    ((l = ci(r)), (u.x = e.x + r.clientLeft), (u.y = e.y + r.clientTop));
  }
  let f = o && !d && !a ? mi(o, c) : Zn(0);
  return {
    width: n.width * l.x,
    height: n.height * l.y,
...
function _i(e) {
  let t = Rr(e),
    ...
    i = Jn(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth),
    a = Jn(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight),
    o = -n.scrollLeft + pi(e),
    s = -n.scrollTop;
  return (
    ei(r).direction === `rtl` && (o += Jn(t.clientWidth, r.clientWidth) - i),
...
function xi(e, t, n) {
  let r;
  if (t === `viewport`) r = yi(e, n);
  else if (t === `document`) r = _i(Rr(e));
  else if (Br(t)) r = bi(t, n);
  else {
    let n = ui(e);
...
function Si(e, t) {
  let n = ni(e);
  return n === t || !Br(n) || $r(n) ? !1 : ei(n).position === `fixed` || Si(n, t);
}
function Ci(e, t) {
  let n = t.get(e);
  if (n) return n;
  let r = ii(e, [], !1).filter((e) => Br(e) && Ir(e) !== `body`),
    i = null,
    a = ei(e).position === `fixed`,
    o = a ? ni(e) : e;
  for (; Br(o) && !$r(o);) {
    let t = ei(o),
      n = Xr(o);
...
function wi(e) {
  let { element: t, boundary: n, rootBoundary: r, strategy: i } = e,
    a = [...(n === `clippingAncestors` ? (Gr(t) ? [] : Ci(t, this._c)) : [].concat(n)), r],
    o = xi(t, a[0], i),
    s = o.top,
    c = o.right,
    l = o.bottom,
  ...
  for (let e = 1; e < a.length; e++) {
    let n = xi(t, a[e], i);
    ((s = Jn(n.top, s)), (c = qn(n.right, c)), (l = qn(n.bottom, l)), (u = Jn(n.left, u)));
  }
  return { width: c - u, height: l - s, x: u, y: s };
}
function Ti(e) {
  let { width: t, height: n } = oi(e);
...
function Ei(e, t, n) {
  ...
  if (r || (!r && !a))
    if (((Ir(t) !== `body` || Ur(i)) && (s = ti(t)), r)) {
      let e = fi(t, !0, a, t);
      ((c.x = e.x + t.clientLeft), (c.y = e.y + t.clientTop));
    } else i && l();
  a && !r && i && l();
  let u = i && !r && !a ? mi(i, s) : Zn(0);
  return {
...
function Di(e) {
  return ei(e).position === `static`;
}
function Oi(e, t) {
  if (!Vr(e) || ei(e).position === `fixed`) return null;
  if (t) return t(e);
...
function ki(e, t) {
  ...
  if (!Vr(e)) {
    let t = ni(e);
    for (; t && !$r(t);) {
      if (Br(t) && !Di(t)) return t;
      t = ni(t);
    }
    return n;
  }
  let r = Oi(e, t);
  for (; r && Wr(r) && Di(r);) r = Oi(r, t);
  return r && $r(r) && Di(r) && !Xr(r) ? n : r || Zr(e) || n;
}
var Ai = async function (e) {
...
function Ni(e, t) {
  ...
  function o(s, c) {
    ...
    if ((s || t(), !f || !p)) return;
    let m = Xn(d),
      h = Xn(i.clientWidth - (u + f)),
      g = Xn(i.clientHeight - (d + p)),
      _ = Xn(u),
      v = {
        rootMargin: -m + `px ` + -h + `px ` + -g + `px ` + -_ + `px`,
        threshold: Jn(0, qn(1, c)) || 1,
      },
      y = !0;
    function b(t) {
...
var Fi = jr,
  ...
  Hi = (e, t, n) => {
    let r = new Map(),
      i = { platform: H, ...n },
      a = { ...i.platform, _c: r };
    return Cr(e, t, { ...i, platform: a });
  },
  Ui = typeof document < `u` ? x.useLayoutEffect : function () {};
function Wi(e, t) {
  if (e === t) return !0;
  ...
  if (e && t && typeof e == `object`) {
    ...
    for (r = n; r-- !== 0;) {
      let n = i[r];
      if (!(n === `_owner` && e.$$typeof) && !Wi(e[n], t[n])) return !1;
    }
    return !0;
  }
  return e !== e && t !== t;
  ...
  let [m, h] = x.useState(null),
    ...
    O = x.useCallback(() => {
      ...
      (D.current && (e.platform = D.current),
        Hi(C.current, w.current, e).then((e) => {
          let t = { ...e, isPositioned: te.current !== !1 };
          k.current &&
            !Wi(T.current, t) &&
            ((T.current = t),
            N.flushSync(() => {
  ...
  (Ui(
    ...
    Ui(() => {
      if ((b && (C.current = b), S && (w.current = S), b && S)) {
        if (E.current) return E.current(b, S, O);
        O();
      }
    }, [b, S, O, E, ee]));
  let A = x.useMemo(() => ({ reference: C, floating: w, setReference: v, setFloating: y }), [v, y]),
    j = x.useMemo(() => ({ reference: b, floating: S }), [b, S]),
    ne = x.useMemo(() => {
      let e = { position: n, left: 0, top: 0 };
      if (!j.floating) return e;
      let t = Ki(j.floating, u.x),
        r = Ki(j.floating, u.y);
      return s
        ? {
            ...e,
            transform: `translate(` + t + `px, ` + r + `px)`,
            ...(Gi(j.floating) >= 1.5 && { willChange: `transform` }),
          }
        : { position: n, left: t, top: r };
    }, [n, s, j.floating, u.x, u.y]);
  return x.useMemo(
    () => ({ ...u, update: O, refs: A, elements: j, floatingStyles: ne }),
    [u, O, A, j, ne],
  );
}
var Yi = (e) => {
    ...
    return {
      ...
      fn(n) {
        ...
        return r && t(r)
          ? r.current == null
            ? {}
            : Bi({ element: r.current, padding: i }).fn(n)
          : r
            ? Bi({ element: r, padding: i }).fn(n)
            : {};
      },
    };
  },
  ...
  ia = x.forwardRef((e, t) => {
    ...
    return (0, S.jsx)(R.svg, {
      ...
      children: e.asChild ? n : (0, S.jsx)(`polygon`, { points: `0,0 30,0 15,10` }),
    });
  });
ia.displayName = ra;
var aa = ia,
...
var fa = `PopperAnchor`,
  pa = x.forwardRef((e, t) => {
    ...
    let u = a.placementState && Ca(a.placementState),
      d = u?.[0],
      f = u?.[1];
    return r
      ? null
...
var ma = `PopperContent`,
  ...
  _a = x.forwardRef((e, t) => {
    let {
      ...
      A = k.length > 0,
      j = { padding: te, boundary: k.filter(xa), altBoundary: A },
      {
        refs: ne,
        floatingStyles: re,
        placement: N,
        ...
        strategy: `fixed`,
        placement: D,
        whileElementsMounted: (...e) => Pi(...e, { animationFrame: p === `always` }),
        elements: { reference: g.anchor },
        middleware: [
          Xi({ mainAxis: i + ee, alignmentAxis: o }),
          c && Zi({ mainAxis: !0, crossAxis: !1, limiter: d === `partial` ? Qi() : void 0, ...j }),
          c && $i({ ...j }),
          ea({
            ...j,
          ...
          b && na({ element: b, padding: s }),
          Sa({ arrowWidth: T, arrowHeight: ee }),
          f && ta({ strategy: `referenceHidden`, ...j, boundary: A ? j.boundary : void 0 }),
        ],
      }),
      oe = g.setPlacementState;
    O(
      () => (
        oe(N),
        () => {
    ...
    return (
      ...
      (0, S.jsx)(`div`, {
        ...
        style: {
          ...
          ...(ae.hide?.referenceHidden && { visibility: `hidden`, pointerEvents: `none` }),
        },
        dir: e.dir,
        children: (0, S.jsx)(ha, {
          scope: n,
          ...
          arrowY: L,
          shouldHideArrow: ce,
          children: (0, S.jsx)(R.div, {
            'data-side': P,
            'data-align': F,
            ...h,
            ref: y,
            style: { ...h.style, animation: ie ? void 0 : `none` },
          }),
        }),
      })
    );
...
_a.displayName = ma;
var va = `PopperArrow`,
  ya = { top: `bottom`, right: `left`, bottom: `top`, left: `right` },
  ba = x.forwardRef(function (e, t) {
    ...
    return (0, S.jsx)(`span`, {
      ...
      children: (0, S.jsx)(aa, { ...r, ref: t, style: { ...r.style, display: `block` } }),
    });
  });
ba.displayName = va;
function xa(e) {
...
var wa = da,
  ...
  ka = x.forwardRef((e, t) => {
    ...
    return o ? N.createPortal((0, S.jsx)(R.div, { ...r, ref: t }), o) : null;
  });
ka.displayName = Oa;
function Aa(e, t) {
...
function Ma(e) {
  ...
  return (
    x.useEffect(() => {
      s === `mounted`
        ? ((a.current = o.current ?? Fa(r.current)), (o.current = void 0))
        : (a.current = `none`);
    }, [s]),
    O(() => {
      let t = r.current,
    ...
    O(() => {
      if (t) {
        let e,
          ...
          o = (a) => {
            let o = Fa(r.current).includes(CSS.escape(a.animationName));
          ...
          s = (e) => {
            e.target === t && (a.current = Fa(r.current));
          };
        return (
      ...
      if (r)
        return () => {
          for (let e = 0; e < i.length; e++) {
            let t = i[e];
            typeof t == `function` ? t() : Na(n[e], null);
          }
        };
    }, [])
  );
...
var La = Object.freeze({
  ...
  Ra = `VisuallyHidden`,
  za = x.forwardRef((e, t) => (0, S.jsx)(R.span, { ...e, ref: t, style: { ...La, ...e.style } }));
za.displayName = Ra;
var Ba = function (e) {
  ...
  qa = function (e, t, n, r) {
    var i = Ka(t, Array.isArray(e) ? e : [e]);
    ...
    return (
      ...
      function () {
        (o.forEach(function (e) {
          ...
          (Va.set(e, t),
            a.set(e, i),
            t || (Ha.has(e) || e.removeAttribute(r), Ha.delete(e)),
            i || e.removeAttribute(n));
        }),
          Wa--,
          Wa || ((Va = new WeakMap()), (Va = new WeakMap()), (Ha = new WeakMap()), (Ua = {})));
      }
    );
  },
  Ja = function (e, t, n) {
...
var io = typeof window < `u` ? x.useLayoutEffect : x.useEffect,
  ao = new WeakMap();
function oo(e, t) {
  var n = ro(t || null, function (t) {
...
function lo(e) {
  e === void 0 && (e = {});
  var t = co(null);
  return ((t.options = Ya({ async: !0, ssr: !1 }, e)), t);
}
var U = function (e) {
  var t = e.sideCar,
    n = Xa(e, [`sideCar`]);
...
var uo = lo(),
  ...
  po = x.forwardRef(function (e, t) {
    var n = x.useRef(null),
      r = x.useState({ onScrollCapture: fo, onWheelCapture: fo, onTouchMoveCapture: fo }),
      i = r[0],
      a = r[1],
      o = e.forwardProps,
      s = e.children,
    ...
    return x.createElement(
      ...
      o
        ? x.cloneElement(x.Children.only(s), Ya(Ya({}, w), { ref: C }))
        : x.createElement(v, Ya({}, w, { className: c, ref: C }), s),
    );
  });
((po.defaultProps = { enabled: !0, removeScrollBar: !0, inert: !1 }),
  (po.classNames = { fullWidth: $a, zeroRight: Qa }));
var mo,
  ho = function () {
    if (mo) return mo;
...
var yo = function () {
  ...
  wo = function (e) {
    ...
    return [Co(n), Co(r), Co(i)];
  },
  To = function (e) {
    if ((e === void 0 && (e = `margin`), typeof window > `u`)) return So;
    var t = wo(e),
...
`
  ...
  Ao = function () {
    x.useEffect(function () {
      return (
        document.body.setAttribute(Do, (ko() + 1).toString()),
        function () {
          var e = ko() - 1;
  ...
  jo = function (e) {
    ...
    return x.createElement(Eo, { styles: Oo(a, !t, i, n ? `` : `!important`) });
  },
  Mo = !1;
if (typeof window < `u`)
  try {
...
var Po = Mo ? { passive: !1 } : !1,
  ...
  Io = function (e, t) {
    ...
    return n[t] !== `hidden` && !(n.overflowY === n.overflowX && !Fo(e) && n[t] === `visible`);
  },
  Lo = function (e) {
  ...
  zo = function (e, t) {
    var n = t.ownerDocument,
      r = t;
    do {
      if ((typeof ShadowRoot < `u` && r instanceof ShadowRoot && (r = r.host), Ho(e, r))) {
        var i = Uo(e, r);
        if (i[1] > i[2]) return !0;
      }
      r = r.parentNode;
  ...
  Uo = function (e, t) {
    return e === `v` ? Bo(t) : Vo(t);
  },
  Wo = function (e, t) {
    return e === `h` && t === `rtl` ? -1 : 1;
  },
  Go = function (e, t, n, r, i) {
    var a = Wo(e, window.getComputedStyle(t).direction),
      o = a * r,
      s = n.target,
      c = t.contains(s),
      l = !1,
...
function $o(e) {
    ...
    x.useEffect(
      function () {
        if (e.inert) {
          ...
          var t = Za([e.lockRef.current], (e.shards || []).map(Jo), !0).filter(Boolean);
          return (
  ...
  var s = x.useCallback(function (e, t) {
      ...
      var m = zo(d, u);
      if (!m) return !0;
      if ((m ? (l = d) : ((l = d === `v` ? `h` : `v`), (m = zo(d, u))), !m)) return !1;
      if ((!r.current && `changedTouches` in e && (s || c) && (r.current = l), !l)) return !0;
      var h = r.current || l;
      return Go(h, t, e, h === `h` ? s : c, !0);
    }, []),
    c = x.useCallback(function (e) {
      var n = e;
      if (!(!Qo.length || Qo[Qo.length - 1] !== a)) {
    ...
    l = x.useCallback(function (e, n, r, i) {
      var a = { name: e, delta: n, target: r, should: i, shadowParent: es(r) };
      (t.current.push(a),
        setTimeout(function () {
    ...
    u = x.useCallback(function (e) {
      ((n.current = Ko(e)), (r.current = void 0));
    }, []),
    d = x.useCallback(function (t) {
      l(t.type, qo(t), t.target, s(t, e.lockRef.current));
    }, []),
    f = x.useCallback(function (t) {
      l(t.type, Ko(t), t.target, s(t, e.lockRef.current));
    }, []);
  x.useEffect(function () {
    return (
      Qo.push(a),
      e.setCallbacks({ onScrollCapture: d, onWheelCapture: d, onTouchMoveCapture: f }),
      document.addEventListener(`wheel`, c, Po),
      document.addEventListener(`touchmove`, c, Po),
      document.addEventListener(`touchstart`, u, Po),
      function () {
        ((Qo = Qo.filter(function (e) {
          return e !== a;
        })),
          document.removeEventListener(`wheel`, c, Po),
          document.removeEventListener(`touchmove`, c, Po),
  ...
  return x.createElement(
    x.Fragment,
    null,
    m ? x.createElement(a, { styles: Xo(i) }) : null,
    p ? x.createElement(jo, { noRelative: e.noRelative, gapMode: e.gapMode }) : null,
  );
}
function es(e) {
...
var ts = W(uo, $o),
  ns = x.forwardRef(function (e, t) {
    return x.createElement(po, Ya({}, e, { ref: t, sideCar: ts }));
  });
ns.classNames = po.classNames;
var rs = [` `, `Enter`, `ArrowUp`, `ArrowDown`],
  is = [` `, `Enter`],
  as = `Select`,
  [os, ss, cs] = an(as),
  [ls, us] = D(as, [cs, ca]),
...
function _s(e) {
  let {
    ...
    [C, w] = x.useState(!1),
    T = sn(l),
    [ee, E] = A({ prop: r, defaultProp: i ?? !1, onChange: a, caller: as }),
    [D, te] = A({ prop: o, defaultProp: s, onChange: c, caller: as }),
    O = x.useRef(null),
    k = x.useRef(D);
  x.useEffect(() => {
  ...
  return (0, S.jsx)(wa, {
    ...
    children: (0, S.jsx)(fs, {
      scope: t,
      ...oe,
      children: (0, S.jsx)(os.Provider, {
        scope: t,
        children: (0, S.jsx)(ms, {
          scope: t,
          onNativeOptionAdd: ie,
          onNativeOptionRemove: ae,
          children: _c(h) ? h(oe) : n,
        }),
      }),
    }),
  });
...
var vs = (e) => {
  ...
  return (0, S.jsx)(_s, {
    ...
    ...r,
    internal_do_not_use_render: ({ isFormControl: e }) =>
      (0, S.jsxs)(S.Fragment, { children: [n, e ? (0, S.jsx)(gc, { __scopeSelect: t }) : null] }),
  });
};
vs.displayName = as;
  ...
  bs = x.forwardRef((e, t) => {
    ...
    return (0, S.jsx)(Ta, {
      ...
      children: (0, S.jsx)(R.button, {
        ...
        disabled: s,
        'data-disabled': s ? `` : void 0,
        'data-placeholder': vc(o.value) ? `` : void 0,
        ...i,
        ref: c,
        onClick: w(i.onClick, (e) => {
          (e.currentTarget.focus(), u.current !== `mouse` && m(e));
        }),
        onPointerDown: w(i.onPointerDown, (e) => {
        ...
        onKeyDown: w(i.onKeyDown, (e) => {
          let t = d.current !== ``;
          (!(e.ctrlKey || e.altKey || e.metaKey) && e.key.length === 1 && f(e.key),
            !(t && e.key === ` `) && rs.includes(e.key) && (m(), e.preventDefault()));
        }),
      }),
    });
  });
...
var xs = `SelectValue`,
  Ss = x.forwardRef((e, t) => {
    ...
    return (0, S.jsx)(R.span, {
      ...
      children: (0, S.jsx)(x.Fragment, { children: f ? o : a }, f ? `placeholder` : `value`),
    });
  });
Ss.displayName = xs;
var Cs = `SelectIcon`,
  ws = x.forwardRef((e, t) => {
    ...
    return (0, S.jsx)(R.span, { 'aria-hidden': !0, ...i, ref: t, children: r || `▼` });
  });
ws.displayName = Cs;
var Ts = `SelectPortal`,
  [Es, Ds] = ls(Ts, { forceMount: void 0 }),
  Os = (e) => {
    let { __scopeSelect: t, forceMount: n, ...r } = e;
    return (0, S.jsx)(Es, {
      scope: e.__scopeSelect,
      forceMount: n,
      children: (0, S.jsx)(ka, { asChild: !0, ...r }),
    });
  };
Os.displayName = Ts;
var ks = `SelectContent`,
  As = x.forwardRef((e, t) => {
    let n = Ds(ks, e.__scopeSelect),
      { forceMount: r = n.forceMount, ...i } = e,
      a = ps(ks, e.__scopeSelect),
      [o, s] = x.useState();
    return (
      O(() => {
      ...
      (0, S.jsx)(ja, {
        present: r || a.open,
        children: ({ present: e }) =>
          e ? (0, S.jsx)(Ls, { ...i, ref: t }) : (0, S.jsx)(js, { ...i, fragment: o }),
      })
    );
  });
As.displayName = ks;
var js = x.forwardRef((e, t) => {
  let { __scopeSelect: n, children: r, fragment: i } = e;
  return i
    ? N.createPortal(
        (0, S.jsx)(Ns, {
          scope: n,
          children: (0, S.jsx)(os.Slot, {
            scope: n,
            children: (0, S.jsx)(`div`, { ref: t, children: r }),
          }),
        }),
        i,
      )
...
js.displayName = `SelectContentFragment`;
var Ms = 10,
  [Ns, Ps] = ls(ks),
  Fs = `SelectContentImpl`,
  Is = ie(`SelectContent.RemoveScroll`),
  Ls = x.forwardRef((e, t) => {
    ...
    let M = x.useCallback(
      ...
      N = x.useCallback(() => M([D, y]), [M, D, y]);
    x.useEffect(() => {
      j && N();
    }, [j, N]);
    let { onOpenChange: ie, triggerPointerDownPosRef: ae } = v;
    (x.useEffect(() => {
      if (y) {
        let e = { x: 0, y: 0 },
          t = (t) => {
            e = {
              x: Math.abs(Math.round(t.pageX) - (ae.current?.x ?? 0)),
              y: Math.abs(Math.round(t.pageY) - (ae.current?.y ?? 0)),
            };
          },
          n = (n) => {
            (e.x <= 10 && e.y <= 10 ? n.preventDefault() : n.composedPath().includes(y) || ie(!1),
    ...
    let [oe, P] = yc((e) => {
      ...
      F = x.useCallback(
        (e, t, n) => {
          let r = !re.current && !n;
          ((v.value !== void 0 && v.value === t) || r) && (te(e), r && (re.current = !0));
        },
        [v.value],
      ),
      I = x.useCallback(() => y?.focus(), [y]),
      se = x.useCallback(
        (e, t, n) => {
          let r = !re.current && !n;
          ((v.value !== void 0 && v.value === t) || r) && k(e);
        },
        [v.value],
      ),
      L = r === `popper` ? Vs : zs,
...
var Rs = `SelectItemAlignedPosition`,
  zs = x.forwardRef((e, t) => {
    let { __scopeSelect: n, onPlaced: r, ...i } = e,
      ...
      p = x.useRef(!1),
      m = x.useRef(!0),
      { viewport: h, selectedItem: g, selectedItemText: _, focusSelectedItem: v } = o,
      y = x.useCallback(() => {
        if (a.trigger && a.valueNode && s && l && h && g && _) {
          ...
          if (a.dir !== `rtl`) {
            let r = i.left - t.left,
              ...
              u = window.innerWidth - Ms,
              d = rn(a, [Ms, Math.max(Ms, u - l)]);
          ...
          if (O <= ee) {
            ...
            let t = l.clientHeight - h.offsetTop - h.offsetHeight,
              n = O + Math.max(E, D + (e ? T : 0) + t + y);
            s.style.height = n + `px`;
          } else {
            let e = o.length > 0 && g === o[0].ref.current;
            s.style.top = `0px`;
            let t = Math.max(ee, m + h.offsetTop + (e ? w : 0) + D) + k;
            ((s.style.height = t + `px`), (h.scrollTop = O - ee + h.offsetTop));
          }
          ((s.style.margin = `${Ms}px 0`),
            (s.style.minHeight = S + `px`),
            (s.style.maxHeight = c + `px`),
            r?.(),
            requestAnimationFrame(() => (p.current = !0)));
        }
      }, [f, a.trigger, a.valueNode, s, l, h, g, _, a.dir, r]);
    O(() => y(), [y]);
    let [b, C] = x.useState();
    return (
      O(() => {
      ...
      (0, S.jsx)(Hs, {
        ...
        onScrollButtonChange: x.useCallback(
          (e) => {
...
var Bs = `SelectPopperPosition`,
  Vs = x.forwardRef((e, t) => {
    let { __scopeSelect: n, align: r = `start`, collisionPadding: i = Ms, ...a } = e,
      o = ds(n);
    return (0, S.jsx)(Ea, {
      ...o,
      ...a,
...
var Ks = `SelectGroup`,
  ...
  Ys = x.forwardRef((e, t) => {
    ...
    return (0, S.jsx)(qs, {
      scope: n,
      id: i,
      children: (0, S.jsx)(R.div, { role: `group`, 'aria-labelledby': i, ...r, ref: t }),
    });
  });
Ys.displayName = Ks;
var Xs = `SelectLabel`,
  Zs = x.forwardRef((e, t) => {
    let { __scopeSelect: n, ...r } = e,
      i = Js(Xs, n);
    return (0, S.jsx)(R.div, { id: i.id, ...r, ref: t });
  });
Zs.displayName = Xs;
var Qs = `SelectItem`,
  [$s, ec] = ls(Qs),
    ...
    return (0, S.jsx)($s, {
      ...
      children: (0, S.jsx)(os.ItemSlot, {
        ...
        children: (0, S.jsx)(R.div, {
          ...
          ...o,
          ref: m,
          onFocus: w(o.onFocus, () => p(!0)),
          onBlur: w(o.onBlur, () => p(!1)),
          onClick: w(o.onClick, () => {
            g.current !== `mouse` && _();
          }),
          onPointerUp: w(o.onPointerUp, () => {
            g.current === `mouse` && _();
          }),
          onPointerDown: w(o.onPointerDown, (e) => {
            g.current = e.pointerType;
          }),
          onPointerMove: w(o.onPointerMove, (e) => {
            ((g.current = e.pointerType),
              i
                ? c.onItemLeave?.()
                : g.current === `mouse` && e.currentTarget.focus({ preventScroll: !0 }));
          }),
          onPointerLeave: w(o.onPointerLeave, (e) => {
            e.currentTarget === document.activeElement && c.onItemLeave?.();
          }),
          onKeyDown: w(o.onKeyDown, (e) => {
            i ||
              e.target !== e.currentTarget ||
              (c.searchRef?.current !== `` && e.key === ` `) ||
              (is.includes(e.key) && _(), e.key === ` ` && e.preventDefault());
          }),
        }),
      }),
    });
...
var nc = `SelectItemText`,
  rc = x.forwardRef((e, t) => {
    let { __scopeSelect: n, className: r, style: i, ...a } = e,
      ...
      l = hs(nc, n),
      [u, d] = x.useState(null),
      f = cn((e) => s.itemTextRefCallback?.(e, c.value, c.disabled)),
      p = E(t, d, c.onItemTextChange, f),
      m = u?.textContent,
      h = x.useMemo(
        () => (0, S.jsx)(`option`, { value: c.value, disabled: c.disabled, children: m }, c.value),
    ...
    return (
      ...
      (0, S.jsxs)(S.Fragment, {
        children: [
          (0, S.jsx)(R.span, { id: c.textId, ...a, ref: p }),
          c.isSelected && o.valueNode && !o.valueNodeHasChildren && !vc(o.value)
...
rc.displayName = nc;
var ic = `SelectItemIndicator`,
  ac = x.forwardRef((e, t) => {
    let { __scopeSelect: n, ...r } = e;
    return ec(ic, n).isSelected ? (0, S.jsx)(R.span, { 'aria-hidden': !0, ...r, ref: t }) : null;
  });
ac.displayName = ic;
var oc = `SelectScrollUpButton`,
  sc = x.forwardRef((e, t) => {
    let n = Ps(oc, e.__scopeSelect),
      r = Us(oc, e.__scopeSelect),
      [i, a] = x.useState(!1),
      o = E(t, r.onScrollButtonChange);
    return (
      O(() => {
...
var cc = `SelectScrollDownButton`,
  lc = x.forwardRef((e, t) => {
    let n = Ps(cc, e.__scopeSelect),
      r = Us(cc, e.__scopeSelect),
      [i, a] = x.useState(!1),
      o = E(t, r.onScrollButtonChange);
    return (
      O(() => {
...
lc.displayName = cc;
var uc = x.forwardRef((e, t) => {
    let { __scopeSelect: n, onAutoScroll: r, ...i } = e,
      a = Ps(`SelectScrollButton`, n),
      o = x.useRef(null),
      s = ss(n),
      c = x.useCallback(() => {
  ...
  fc = x.forwardRef((e, t) => {
    let { __scopeSelect: n, ...r } = e;
    return (0, S.jsx)(R.div, { 'aria-hidden': !0, ...r, ref: t });
  });
fc.displayName = dc;
var pc = `SelectArrow`,
  mc = x.forwardRef((e, t) => {
    let { __scopeSelect: n, ...r } = e,
      i = ds(n);
    return Ps(pc, n).position === `popper` ? (0, S.jsx)(Da, { ...i, ...r, ref: t }) : null;
  });
mc.displayName = pc;
var hc = `SelectBubbleInput`,
  gc = x.forwardRef(({ __scopeSelect: e, ...t }, n) => {
    let r = ps(hc, e),
      {
        value: i,
        onValueChange: a,
      ...
      h = i ?? ``,
      g = re(h),
      _ = Array.from(d).some((e) => (e.props.value ?? ``) === ``);
    return (
      x.useEffect(() => {
        let e = p.current;
        if (!e) return;
      ...
      (0, S.jsxs)(
        R.select,
        {
          ...
          ref: m,
          defaultValue: h,
          children: [vc(i) && !_ ? (0, S.jsx)(`option`, { value: `` }) : null, Array.from(d)],
        },
        f,
      )
    );
...
function yc(e) {
  ...
  return (x.useEffect(() => () => window.clearTimeout(r.current), []), [n, i, a]);
}
function bc(e, t, n) {
...
var Sc = (...e) =>
    e
      ...
      .join(` `)
      .trim(),
  Cc = (e) => e.replace(/([a-z0-9])([A-Z])/g, `$1-$2`).toLowerCase(),
  wc = (e) =>
  ...
  Oc = (0, x.createContext)({}),
  kc = () => (0, x.useContext)(Oc),
  Ac = (0, x.forwardRef)(
    (
      {
        color: e,
      ...
      return (0, x.createElement)(
        `svg`,
        {
          ...
          ...Ec,
          width: t ?? l ?? Ec.width,
          height: t ?? l ?? Ec.height,
          stroke: e ?? f,
          strokeWidth: m,
          className: Sc(`lucide`, p, i),
          ...(!a && !Dc(s) && { 'aria-hidden': `true` }),
          ...s,
        },
  ...
  jc = (e, t) => {
    let n = (0, x.forwardRef)(({ className: n, ...r }, i) =>
      (0, x.createElement)(Ac, {
        ref: i,
        iconNode: t,
        className: Sc(`lucide-${Cc(Tc(e))}`, `lucide-${e}`, n),
        ...r,
      }),
    );
    return ((n.displayName = Tc(e)), n);
  },
  Mc = jc(`chevron-down`, [[`path`, { d: `m6 9 6 6 6-6`, key: `qrunsl` }]]),
  Nc = jc(`plus`, [
  ...
  G = vs,
  Lc = Ss,
  Rc = (0, x.forwardRef)(({ className: e, children: t, ...n }, r) =>
    (0, S.jsxs)(bs, {
      ref: r,
      className: tn(
      ...
      children: [
        ...
        (0, S.jsx)(ws, {
          asChild: !0,
          children: (0, S.jsx)(Mc, { className: `h-4 w-4 opacity-50` }),
        }),
      ],
    }),
  );
Rc.displayName = bs.displayName;
var zc = (0, x.forwardRef)(({ className: e, children: t, position: n = `popper`, ...r }, i) =>
  (0, S.jsx)(Os, {
    children: (0, S.jsx)(As, {
      ref: i,
      className: tn(
...
zc.displayName = As.displayName;
var Bc = (0, x.forwardRef)(({ className: e, children: t, ...n }, r) =>
  (0, S.jsx)(tc, {
    ref: r,
    className: tn(
    ...
    ...n,
    children: (0, S.jsx)(rc, { children: t }),
  }),
);
Bc.displayName = tc.displayName;
var Vc = (0, x.forwardRef)(({ className: e, type: t, ...n }, r) =>
  (0, S.jsx)(`input`, {
    type: t,
    className: tn(
...
var Hc = (e) => (typeof e == `boolean` ? `${e}` : e === 0 ? `0` : e),
  Uc = ke,
  Wc = ((e, t) => (n) => {
    if (t?.variants == null) return Uc(e, n?.class, n?.className);
  ...
  Gc = (0, x.forwardRef)(({ className: e, variant: t, size: n, ...r }, i) =>
    (0, S.jsx)(`button`, {
      className: tn(Wc({ variant: t, size: n, className: e })),
      ref: i,
      ...r,
    }),
  );
