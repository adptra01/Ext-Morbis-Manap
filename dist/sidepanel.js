...
function Badge({ variant = "default", icon, children, className, onDismiss }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		className: cn("inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[10px] font-semibold", variants[variant], className),
		children: [
...
function RoleSelector({ value, onChange }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
		...
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, { children: roleOptions.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
			value: opt.value,
			children: opt.label
		}, opt.value)) })]
	});
...
function ConsultationInfoPanel({ data }) {
	...
	const loadTab = async (tabId) => {
		...
		try {
			...
			setContents((prev) => ({
				...prev,
				[tabId]: res?.success ? res.html : `<div style="color:red;padding:20px;">Gagal memuat</div>`
			}));
		} catch {
			setContents((prev) => ({
				...prev,
