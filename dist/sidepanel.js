...
function useDarkMode() {
	...
	const setAndStore = (0, import_react.useCallback)((t) => {
		setTheme(t);
		applyTheme(t);
...
function Badge({ variant = "default", icon, children, className, onDismiss }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		className: cn("inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-base font-semibold", variants[variant], className),
		children: [
			icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "size-3.5" }),
			children,
...
function RoleSelector({ value, onChange }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
		...
		children: roleOptions.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
			value: opt.value,
			children: opt.label
		}, opt.value))
	});
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Switch, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: "MORBIS Ext"
				}), enabled && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
					variant: "success",
					children: "Aktif"
				})]
              ...
              `,
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							}), feature.comingSoon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: [feature.key === "openDetailInNewTab" && feature.modes && enabledFeatures[feature.key] && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
							...
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, { children: Object.entries(feature.modes).map(([k, v]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
								value: k,
...
function DomainPanel({ urls, onAdd, onRemove, onToggle }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			urls.length === 0 && !error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "text-center py-8",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-md-sm text-muted-foreground",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "space-y-1",
				children: urls.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						item.isDefault && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function BatchUploadPanel({ tabId }) {
	...
	const sendTabAction = (0, import_react.useCallback)(async (action, payload) => {
		try {
	...
	const filteredItems = items.filter((item) => {
		...
		return item.filename.toLowerCase().includes(query) || item.keterangan.toLowerCase().includes(query) || item.norm.toLowerCase().includes(query);
	});
	const selectedCount = items.filter((i) => i.selected !== false).length;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-4",
		children: [
			...
			mode === "manual" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "space-y-2",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						...
						className: "w-full",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "size-3.5 mr-1" }), " Analisis URL"]
					})
				]
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "space-y-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "size-3.5 mr-1" }), " Cari Dokumen Pasien Otomatis"]
				})]
			}),
			statusText && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: statusText
					}), isProcessing && progress > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "text-[10px] font-semibold text-primary",
						children: [Math.round(progress), "%"]
					})]
				}), isProcessing && progress > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			items.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}), mode === "auto" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
						placeholder: "Cari...",
						value: searchQuery,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										}), item.status !== "pending" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
											variant: item.status === "success" ? "success" : "danger",
											className: "shrink-0 scale-90",
											children: item.status === "success" ? "Sukses" : "Gagal"
										})]
									}),
									item.tglFileTabel ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "text-[10px] text-muted-foreground flex gap-1.5",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Dibuat: ", item.tglFileTabel] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "|" }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Unggah: ", item.tglUploadTabel] })
										]
									}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "text-[10px] text-muted-foreground flex gap-1.5",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["NORM: ", item.norm || "-"] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "|" }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Tgl Klaim: ", item.tanggal] })
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
									...
									item.error && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					}, idx)), filteredItems.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex gap-2",
				children: showFinishedReload ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
					onClick: handleReload,
					variant: "default",
					className: "w-full bg-green-600 hover:bg-green-700 text-white",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { className: "size-3.5 mr-1" }), " Reload Halaman"]
					...
					className: "flex-1",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Upload, { className: "size-3.5 mr-1" }), " Mulai Upload"]
				})] })
			})
		]
	});
...
function BatchDeletePanel({ tabId }) {
	...
	const filteredItems = items.filter((item) => {
		if (!searchQuery) return true;
		const query = searchQuery.toLowerCase();
		return item.filename.toLowerCase().includes(query) || item.keterangan.toLowerCase().includes(query) || item.id_dokumen.toLowerCase().includes(query);
	});
	const selectedCount = items.filter((i) => i.selected).length;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-4",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, { className: "size-4 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "PERHATIAN!" })]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "text-[11px] leading-relaxed opacity-90",
					children: [
						"File yang dihapus ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "tidak dapat dikembalikan" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
					...
					disabled: isProcessing,
					className: "w-full border-primary/20 hover:bg-primary/5 text-primary",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "size-3.5 mr-1" }), " Cari Dokumen Pasien"]
				})
			}),
			statusText && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "p-2.5 bg-accent/40 rounded-md border border-border space-y-1.5 animate-in fade-in duration-200",
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											...
											variant: item.status === "success" ? "success" : item.status === "deleting" ? "warning" : "danger",
											className: "shrink-0 scale-90",
											children: item.status === "success" ? "Sukses" : item.status === "deleting" ? "..." : "Gagal"
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "text-[10px] text-muted-foreground flex gap-1.5",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["ID: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
												className: "text-foreground",
												children: item.id_dokumen
											})] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "|" }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item.tglFile })
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function ConsultationDetailPanel({ data }) {
	...
	if (data.permintaan) fields.push({
		label: "Permintaan Konsultasi",
		value: data.permintaan
	});
	if (data.kesan) fields.push({
		label: "Kesan",
		value: data.kesan
	});
	if (data.anjuran) fields.push({
		label: "Anjuran",
		value: data.anjuran
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		}), fields.map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
...
//#endregion
//#region src/features/shared/sanitizeHtml.ts
/**
...
function sanitizeHtml(html) {
	...
	try {
		...
		doc.body.querySelectorAll("script, iframe, object, embed, link, meta").forEach((n) => n.remove());
		let ctrlChars = "";
		for (let i = 0; i <= 31; i++) ctrlChars += String.fromCharCode(i);
		ctrlChars += String.fromCharCode(127);
		const CONTROL_WS_RE = new RegExp(`[${ctrlChars}\\s]`, "g");
		const isDangerousUrl = (v) => {
			if (!v) return false;
		...
		doc.body.querySelectorAll("*").forEach((el) => {
			...
			for (const a of ["href", "src"]) if (isDangerousUrl(el.getAttribute(a))) el.removeAttribute(a);
		});
...
function ConsultationInfoPanel({ data }) {
	...
	const loadTab = async (tabId) => {
		...
		try {
			...
			setContents((prev) => ({
				...prev,
				[tabId]: res?.success ? sanitizeHtml(res.html) : `<div style="color:red;padding:20px;">Gagal memuat</div>`
			}));
		} catch {
			setContents((prev) => ({
				...prev,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: loading[activeTab] ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "text-center py-12 text-muted-foreground text-md-sm",
				children: "Memuat..."
			}) : contents[activeTab] ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function Footer({ onReload, onReset }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
			...
			size: "sm",
			onClick: onReload,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { className: "size-3.5" }), "Reload Halaman"]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
			variant: "ghost",
			size: "sm",
			onClick: onReset,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RotateCcw, { className: "size-3.5" }), "Reset Default"]
		})]
	});
}
//#endregion
...
function App() {
	...
	(0, import_react.useEffect)(() => {
		chrome.tabs.query({
			...
			if (activeTabId) {
				...
				sendMessage({ type: "GET_PAGE_CONTEXT" }).then((res) => {
					if (res?.context) {
	...
	(0, import_react.useEffect)(() => {
		sendMessage({ type: MessageTypes.GET_ALL }).then((result) => {
			if (result?.config) {
			...
			chrome.storage.sync.get(["extensionConfig", "extensionCustomUrls"], (fallback) => {
				if (fallback.extensionConfig) {
					...
					if (fallback.extensionConfig.features) setFeaturesList(configToFeatureList(fallback.extensionConfig.features));
				}
	...
	const handleRoleChange = (0, import_react.useCallback)((newRole) => {
		setRole(newRole);
		sendMessage({
	...
	const handleFeatureToggle = (0, import_react.useCallback)((key, val) => {
		const next = {
			...features,
			[key]: val
		};
	...
	const handleAddUrl = (0, import_react.useCallback)((url) => {
	...
	const handleRemoveUrl = (0, import_react.useCallback)((id) => {
	...
	const handleToggleUrl = (0, import_react.useCallback)((id, val) => {
		const next = urls.map((u) => u.id === id ? {
			...u,
			enabled: val
		} : u);
		setUrls(next);
	...
	const handleModeChange = (0, import_react.useCallback)((key, mode) => {
		sendMessage({
	...
	const handleReset = (0, import_react.useCallback)(() => {
		...
		sendMessage({ type: MessageTypes.RESET_CONFIG }).then(() => {
			setFeatures({});
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: resolved ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
							width: "16",
							height: "16",
							viewBox: "0 0 24 24",
							fill: "none",
							...
							stroke: "currentColor",
							strokeWidth: "2",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z" })
						})
					})
				})]
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Aksi Halaman" }), pageContext && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "size-1.5 bg-primary rounded-full inline-block animate-pulse shrink-0" })]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					activeTab === "features" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FeaturesPanel, {
					...
					activeTab === "domain" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DomainPanel, {
						urls,
						onAdd: handleAddUrl,
						onRemove: handleRemoveUrl,
						onToggle: handleToggleUrl
					}),
					activeTab === "tools" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "space-y-4",
						children: [
							pageContext?.feature === "mKlaimDetail" && tabId && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								}), toolsSubTab === "upload" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BatchUploadPanel, { tabId }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BatchDeletePanel, { tabId })]
							}),
							pageContext?.feature === "batchUpload" && tabId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BatchUploadPanel, { tabId }),
							pageContext?.feature === "batchDelete" && tabId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BatchDeletePanel, { tabId }),
							pageContext?.feature === "consultationDetail" && pageContext?.data && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConsultationDetailPanel, { data: pageContext.data }),
							pageContext?.feature === "consultationInfo" && pageContext?.data && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConsultationInfoPanel, { data: pageContext.data }),
							(!pageContext || !tabId) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
if (root) (0, import_client.createRoot)(root).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(App, {}));
//#endregion
