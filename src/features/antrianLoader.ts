...
(function () {
  ...
  function hideOld(): void {
    ...
    s.textContent =
      'html,body{background:#E9F5EE!important;}' +
  ...
  function addOverlay(): void {
    ...
    l.innerHTML =
      ...
      '<div style="width:40%;height:100%;border-radius:999px;background:#198754;animation:ext-m-load 1.2s ease-in-out infinite;"></div>' +
      '</div>' +
