 ...
 * Identical architecture to labDataTables.ts: CDN-load jQuery+DataTables,
 * target `table.tabel`, MutationObserver for PJAX re-inject.
 *
 * ponytail: CDN pattern inherited from labDataTables. Bundling jQuery+DT
 * is the upgrade path if CDN ever goes down.
 */
(function () {
